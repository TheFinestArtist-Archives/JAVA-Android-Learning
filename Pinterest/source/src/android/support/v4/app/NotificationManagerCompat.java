...
public class NotificationManagerCompat
{
        ...
        implements ServiceConnection, android.os.Handler.Callback
    {
        ...
        private boolean ensureServiceBound(ListenerRecord listenerrecord)
        {
            ...
            {
                Log.w("NotifManCompat", (new StringBuilder("Unable to bind to listener ")).append(listenerrecord.componentName).toString());
        ...
        private void processListenerQueue(ListenerRecord listenerrecord)
        {
            ...
            {
                Log.d("NotifManCompat", (new StringBuilder("Processing component ")).append(listenerrecord.componentName).append(", ").append(listenerrecord.taskQueue.size()).append(" queued tasks").toString());
            }
...
_L4:
            ...
            if (Log.isLoggable("NotifManCompat", 3))
            {
                Log.d("NotifManCompat", (new StringBuilder("Sending task ")).append(task).toString());
            }
...
_L3:
            ...
            if (Log.isLoggable("NotifManCompat", 3))
            {
                Log.d("NotifManCompat", (new StringBuilder("Remote service has died: ")).append(listenerrecord.componentName).toString());
            }
_L5:
            if (!listenerrecord.taskQueue.isEmpty())
            {
              ...
              goto _L1
            obj;
            Log.w("NotifManCompat", (new StringBuilder("RemoteException communicating with ")).append(listenerrecord.componentName).toString(), ((Throwable) (obj)));
              goto _L5
        }
        ...
        private void scheduleListenerRetry(ListenerRecord listenerrecord)
        {
            ...
            {
                Log.w("NotifManCompat", (new StringBuilder("Giving up on delivering ")).append(listenerrecord.taskQueue.size()).append(" tasks to ").append(listenerrecord.componentName).append(" after ").append(listenerrecord.retryCount).append(" retries").toString());
