...
class ry extends ry
{
    ...
    public Notification build(ry ry)
    {
        ry ry1 = new ry(ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.ry, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te, ry.te);
        NotificationCompat.access$000(ry1, ry.te);
        NotificationCompat.access$100(ry1, ry.te);
        return ry1.te();
    }
