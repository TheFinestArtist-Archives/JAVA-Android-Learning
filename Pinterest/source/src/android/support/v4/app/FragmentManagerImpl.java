...
_L10:
    ...
    final android.view.LayoutInflater.Factory getLayoutInflaterFactory()
    {
        return this;
    }
...
_L2:
        ...
        fragment.mState;
        JVM INSTR tableswitch 1 5: default 1056
    //                   1 1062
    //                   2 1236
    //                   3 1198
    //                   4 1160
...
_L15:
    ...
    public final View onCreateView(String s, Context context, AttributeSet attributeset)
    {
        ...
        if (s == null)
        {
            obj = findFragmentById(0);
        }
        if (DEBUG)
        {
            Log.v("FragmentManager", (new StringBuilder("onCreateView: id=0x")).append(Integer.toHexString(j)).append(" fname=").append(s1).append(" existing=").append(obj).toString());
        }
        if (obj == null)
        {
...
_L7:
        ...
        while (i <= j) 
        {
            if (DEBUG)
            {
                Log.v("FragmentManager", (new StringBuilder("Popping back stack state: ")).append(s.get(i)).toString());
            }
        ...
        if (((FragmentManagerState) (parcelable = (FragmentManagerState)parcelable)).mActive != null)
        {
            ...
            while (j < ((FragmentManagerState) (parcelable)).mActive.length) 
            {
                ...
                if (fragmentstate != null)
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: active #")).append(j).append(": ").append(fragment2).toString());
                    }
                ...
                } else
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: avail #")).append(j).toString());
                    }
            ...
            if (((FragmentManagerState) (parcelable)).mAdded != null)
            {
                ...
                for (int l = 0; l < ((FragmentManagerState) (parcelable)).mAdded.length; l++)
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: added #")).append(l).append(": ").append(arraylist).toString());
                    }
            ...
            if (((FragmentManagerState) (parcelable)).mBackStack != null)
            {
                ...
                while (i1 < ((FragmentManagerState) (parcelable)).mBackStack.length) 
                {
                    ...
                    if (DEBUG)
                    {
                        Log.v("FragmentManager", (new StringBuilder("restoreAllState: back stack #")).append(i1).append(" (index ").append(((BackStackRecord) (arraylist)).mIndex).append("): ").append(arraylist).toString());
            ...
            if (mAdded != null)
            {
                ...
                if (l > 0)
                {
                    ...
                    do
                    {
                        ...
                        if (DEBUG)
                        {
                            Log.v("FragmentManager", (new StringBuilder("saveAllState: adding fragment #")).append(i).append(": ").append(mAdded.get(i)).toString());
                        }
                        i++;
                    } while (true);
                    break label0;
