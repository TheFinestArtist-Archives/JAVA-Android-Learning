...
public abstract class BetterFragmentStatePagerAdapter extends PagerAdapter
{
    ...
    public void destroyItem(ViewGroup viewgroup, int i, Object obj)
    {
        ...
        Log.v("FragmentStatePagerAdapter", (new StringBuilder("Removing item #")).append(i).append(": f=").append(obj).append(" v=").append(((Fragment)obj).getView()).toString());
    ...
    public void finishUpdate(ViewGroup viewgroup)
    {
        ...
        return;
        viewgroup;
        CrashReporting.logHandledException(viewgroup);
        return;
    }
    ...
    public Object instantiateItem(ViewGroup viewgroup, int i)
    {
        ...
        Log.v("FragmentStatePagerAdapter", (new StringBuilder("Adding item #")).append(i).append(": f=").append(fragment1).toString());
