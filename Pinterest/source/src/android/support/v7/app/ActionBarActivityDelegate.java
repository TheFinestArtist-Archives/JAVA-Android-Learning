...
abstract class ActionBarActivityDelegate
{
    ...
    final WindowCallback mDefaultWindowCallback = new _cls1();
    ...
    final String getUiOptionsFromMetadata()
    {
        ...
        {
            Log.e("ActionBarActivityDelegate", (new StringBuilder("getUiOptionsFromMetadata: Activity '")).append(mActivity.getClass().getSimpleName()).append("' not in manifest").toString());
            return null;
        }
        return s;
    }
