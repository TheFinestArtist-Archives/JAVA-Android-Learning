...
_L7:
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (mThumbDrawable != null)
        {
            ...
            i = i + mThumbWidth + ((Rect) (obj)).right;
...
_L4:
    ...
    public void onMeasure(int i, int j)
    {
        ...
        i1 = rect.left;
        j1 = rect.right;
        i1 = Math.max(mSwitchMinWidth, i1 + mThumbWidth * 2 + j1);
        k = Math.max(l, k);
        mSwitchWidth = i1;
        mSwitchHeight = k;
        super.onMeasure(i, j);
...
_L5:
    ...
    private class _cls1 extends Animation
    {
        ...
        {
            setThumbPosition(startPosition + diff * f);
        }
