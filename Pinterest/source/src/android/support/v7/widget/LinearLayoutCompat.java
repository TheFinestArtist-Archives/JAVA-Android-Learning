...
_L4:
        ...
        i1 = ViewUtils.combineMeasuredStates(i1, ViewCompat.getMeasuredState(view1));
        if (flag2)
        {
...
_L2:
        ...
        k5 = ViewCompat.resolveSizeAndState(Math.max(mTotalLength, getSuggestedMinimumWidth()), i, 0);
        l3 = (0xffffff & k5) - mTotalLength;
        if (i2 == 0 && (l3 == 0 || f <= 0.0F)) goto _L8; else goto _L7
_L7:
label0:
        {
            if (mWeightSum > 0.0F)
            ...
            while (i2 < j6) 
            {
                ...
                if (view3 != null && view3.getVisibility() != 8)
                {
                    ...
                    if (f1 > 0.0F)
                    {
                        ...
                        k = ViewUtils.combineMeasuredStates(k, ViewCompat.getMeasuredState(view3) & 0xff000000);
                        f -= f1;
                        l1 = k1 - k2;
                        k1 = k;
                        k = l1;
...
_L9:
        ...
        setMeasuredDimension(0xff000000 & l | k5, ViewCompat.resolveSizeAndState(Math.max(k + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), j, l << 16));
        if (flag)
        {
...
_L8:
        ...
        i1 = Math.max(i1, k5);
        i2 = ViewUtils.combineMeasuredStates(l, ViewCompat.getMeasuredState(view));
...
_L2:
        ...
        int k4 = ViewCompat.resolveSizeAndState(Math.max(mTotalLength, getSuggestedMinimumHeight()), j, 0);
        ...
        if (j2 != 0 || i3 != 0 && f > 0.0F)
        {
            ...
            while (i2 < l5) 
            {
                ...
                if (view2.getVisibility() != 8)
                {
                    ...
                    float f1 = layoutparams2.weight;
                    int k3;
                    if (f1 > 0.0F)
                    {
                        j2 = (int)(((float)k1 * f1) / f);
                        ...
                        k = ViewUtils.combineMeasuredStates(k, ViewCompat.getMeasuredState(view2) & 0xffffff00);
                        l1 = k1 - j2;
                        k1 = k;
                        f -= f1;
                        k = l1;
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(k + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, j1), k4);
        if (flag)
        {
