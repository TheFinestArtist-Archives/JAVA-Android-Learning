...
_L3:
    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        if (flag)
        {
            ...
            i = layoutparams.bottomMargin + (i + l) + 0;
        }
        if (flag2)
        {
...
_L8:
        if (k1 != 0)
        {
            ...
            if (flag2)
            {
                ...
                mSubtitleTextView.layout(j - k1, i, j, l1 + i);
                i = mTitleMarginEnd;
        ...
        } else
        {
            ...
            if (flag2)
            {
                ...
                l1 = mSubtitleTextView.getMeasuredHeight();
                mSubtitleTextView.layout(k, l, i, l1 + l);
                l = mTitleMarginEnd;
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        while (j1 < i2) 
        {
            ...
            if (((LayoutParams)view.getLayoutParams()).mViewType == 0 && shouldLayout(view))
            {
                ...
                i1 = Math.max(l, view.getMeasuredHeight() + getVerticalMargins(view));
        ...
        k1 = 0;
        j1 = 0;
        i3 = mTitleMarginTop + mTitleMarginBottom;
        j3 = mTitleMarginStart + mTitleMarginEnd;
        i1 = k;
        if (shouldLayout(mTitleTextView))
        {
            measureChildCollapseMargins(mTitleTextView, i, l1 + j3, j, i3, ai);
        ...
        {
            j2 = Math.max(k1, measureChildCollapseMargins(mSubtitleTextView, i, l1 + j3, j, i3 + j1, ai));
            l2 = j1 + (mSubtitleTextView.getMeasuredHeight() + getVerticalMargins(mSubtitleTextView));
        ...
        i1 = getPaddingTop();
        j1 = getPaddingBottom();
        k1 = ViewCompat.resolveSizeAndState(Math.max(j2 + l1 + (k1 + l2), getSuggestedMinimumWidth()), i, 0xff000000 & k);
