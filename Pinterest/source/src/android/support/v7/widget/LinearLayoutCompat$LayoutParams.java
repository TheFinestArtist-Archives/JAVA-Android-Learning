...
public class gravity extends android.view.LayoutParams
{
    ...
    public weight(int i, int j, float f)
    {
        super(i, j);
        gravity = -1;
        weight = f;
    ...
    public t_Layout_android_layout_gravity(t_Layout_android_layout_gravity t_layout_android_layout_gravity)
    {
        super(t_layout_android_layout_gravity);
        gravity = -1;
        weight = t_layout_android_layout_gravity.weight;
        gravity = t_layout_android_layout_gravity.gravity;
    }
