    ...
    implements android.view.oolbarWidgetWrapper._cls1
{
    ...
    public void onClick(View view)
    {
        ...
        {
            ToolbarWidgetWrapper.access$200(ToolbarWidgetWrapper.this).onMenuItemSelected(0, mNavItem);
        }
    }
    ...
    ()
    {
        ...
        super();
        mNavItem = new ActionMenuItem(ToolbarWidgetWrapper.access$000(ToolbarWidgetWrapper.this).getContext(), ToolbarWidgetWrapper.access$100(ToolbarWidgetWrapper.this));
    }
}
