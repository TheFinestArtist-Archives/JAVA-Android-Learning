...
_L3:
        ...
        mPopup = context;
        mForwardingListener = new _cls1(context);
...
_L6:
    ...
    public void onRestoreInstanceState(Parcelable parcelable)
    {
        ...
        if (((SavedState) (parcelable)).showDropdown)
        {
            ...
            if (parcelable != null)
            {
                parcelable.addOnGlobalLayoutListener(new _cls2());
            }
        }
    }
...
// JavaClassFileOutputException: Invalid index accessing method local variables table of <init>
    ...
    private class _cls1 extends android.support.v7.widget.ListPopupWindow.ForwardingListener
    {
