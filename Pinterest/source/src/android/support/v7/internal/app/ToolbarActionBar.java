...
public class ToolbarActionBar extends ActionBar
{
    ...
    private Menu getMenu()
    {
        if (!mMenuCallbackSet)
        {
            mToolbar.setMenuCallbacks(new ActionMenuPresenterCallback(null), new MenuBuilderCallback(null));
    ...
    public void setListMenuPresenter(ListMenuPresenter listmenupresenter)
    {
        ...
        if (obj instanceof MenuBuilder)
        {
            ...
            if (mListMenuPresenter != null)
            {
                ...
                ((MenuBuilder) (obj)).b(mListMenuPresenter);
            }
            mListMenuPresenter = listmenupresenter;
            if (listmenupresenter != null)
            {
                listmenupresenter.setCallback(new PanelMenuPresenterCallback(null));
                ((MenuBuilder) (obj)).a(listmenupresenter);
            }
        }
    }
