...
label0:
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        MenuAdapter.a(adapterview).b(adapterview.a(i));
    }
...
_L2:
    ...
    private class MenuAdapter extends BaseAdapter
    {
        ...
        static MenuBuilder a(MenuAdapter menuadapter)
        {
            return menuadapter.b;
        }

        private void a()
        {
            MenuItemImpl menuitemimpl = a.mMenu.q();
            if (menuitemimpl != null)
            {
                ArrayList arraylist = a.mMenu.n();
        ...
        public View getView(int i, View view, ViewGroup viewgroup)
        {
            if (view == null)
            {
                view = a.mInflater.inflate(MenuPopupHelper.ITEM_LAYOUT, viewgroup, false);
            }
