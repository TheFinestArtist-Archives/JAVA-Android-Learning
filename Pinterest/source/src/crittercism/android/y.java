...
public final class y extends java.security.Provider.Service
{
    ...
    private y(java.security.Provider.Service service, d d1, c c1)
    {
    ...
    private static y a(java.security.Provider.Service service, d d1, c c1)
    {
        c1 = new y(service, d1, c1);
...
_L2:
        ...
        afield[i].set(c1, afield[i].get(service));
        i++;
...
_L1:
    ...
    public static boolean a(d d1, c c1)
    {
        int i = 0;
        Provider provider;
        if (z.a())
            ...
            if ((provider = a()) != null)
            {
                ...
                for (flag = false; i < a.length; flag = flag1)
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        if (!(obj instanceof y))
                        {
                            obj = a(((java.security.Provider.Service) (obj)), d1, c1);
                            flag1 = flag;
                            if (obj != null)
                            {
                                flag1 = flag | ((y) (obj)).b();
