...
_L4:
        ...
        {
            throw new DaoException((new StringBuilder("Illegal date value: expected java.util.Date or Long for value ")).append(obj).toString());
        }
...
_L5:
        ...
        if (j != 0)
        {
            ...
            if (j != 1)
            {
                throw new DaoException((new StringBuilder("Illegal boolean value: numbers must be 0 or 1, but was ")).append(obj).toString());
            }
        }
...
_L7:
        ...
        if (obj instanceof String)
        {
            ...
            {
                throw new DaoException((new StringBuilder("Illegal boolean value: Strings must be \"TRUE\" or \"FALSE\" (case insesnsitive), but was ")).append(obj).toString());
            }
        }
