...
public class Property
{
    ...
    {
        return new WhereCondition.PropertyCondition(this, " BETWEEN ? AND ?", new Object[] {
            obj, obj1
        });
    }
    ...
    public transient WhereCondition in(Object aobj[])
    {
        ...
        return new WhereCondition.PropertyCondition(this, stringbuilder.toString(), aobj);
    }
