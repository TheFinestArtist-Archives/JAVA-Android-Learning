...
//            ErrorDialogFragmentFactory, ErrorDialogConfig, ThrowableFailureEvent, HasExecutionScope
...
public class ErrorDialogManager
{
    ...
    {
        if (obj != null && (throwablefailureevent instanceof HasExecutionScope))
        {
...
_L5:
    ...
    private class SupportManagerFragment extends Fragment
    {
    ...
    private class HoneycombManagerFragment extends android.app.Fragment
    {
        ...
        public void onEventMainThread(ThrowableFailureEvent throwablefailureevent)
        {
            if (ErrorDialogManager.isInExecutionScope(executionScope, throwablefailureevent))
            {
                ...
                throwablefailureevent = (android.app.DialogFragment)ErrorDialogManager.factory.prepareErrorFragment(throwablefailureevent, finishAfterDialog, argumentsForErrorDialog);
                if (throwablefailureevent != null)
                {
                    throwablefailureevent.show(fragmentmanager, "de.greenrobot.eventbus.error_dialog");
                    return;
