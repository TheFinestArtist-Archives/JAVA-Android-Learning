...
public final class ConstructorConstructor
{
    ...
    public final ObjectConstructor get(final TypeToken typeCreator)
    {
        ...
        implements ObjectConstructor
    {
        ...
        public Object construct()
        {
            ...
            {
                throw new RuntimeException((new StringBuilder("Failed to invoke ")).append(constructor).append(" with no args").toString(), instantiationexception);
            }
            catch (InvocationTargetException invocationtargetexception)
            {
                throw new RuntimeException((new StringBuilder("Failed to invoke ")).append(constructor).append(" with no args").toString(), invocationtargetexception.getTargetException());
            }
        ...
        implements ObjectConstructor
    {
        ...
        public Object construct()
        {
            ...
            {
                throw new RuntimeException((new StringBuilder("Unable to invoke no-args constructor for ")).append(type).append(". Register an InstanceCreator with Gson for this type may fix this problem.").toString(), exception);
            }
            return obj;
        }
