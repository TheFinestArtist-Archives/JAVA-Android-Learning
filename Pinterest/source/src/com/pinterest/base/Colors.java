...
public class Colors
{
    ...
    public static final int BG_GRID = Resources.color(0x7f090011);
    public static final int BG_GRID_DARK = Resources.color(0x7f090012);
    public static final int BG_TOUCH = Resources.color(0x7f090019);
    public static final int BG_TOUCH_IMAGE = Resources.color(0x7f090019);
    public static final int BLACK = Resources.color(0x7f09001b);
    public static final int GRAY_DARK_SOLID = Resources.color(0x7f090044);
    public static final int GRAY_SOLID = Resources.color(0x7f090043);
    public static final int LIGHTEST_GRAY_SOLID = Resources.color(0x7f09004a);
    public static final int LIGHT_GRAY = Resources.color(0x7f090049);
    public static final int LIGHT_GRAY_SOLID = Resources.color(0x7f090047);
    public static final int MAX_HUE = 360;
    public static final int RED = Resources.color(0x7f090061);
    public static final int TEXT_DARK = Resources.color(0x7f09006b);
    public static final int TEXT_LIGHT = Resources.color(0x7f09006c);
    public static final int TEXT_PLAIN_BUTTON = Resources.color(0x7f09006b);
    public static final int TRANSPARENT = Resources.color(0x106000d);
    public static final int WHITE = Resources.color(0x7f090073);
