...
public class Social
{
    ...
    public static final List FB_READ_PERMISSIONS = new _cls2();
    public static final List FB_REQUIRED_PERMISSIONS = new _cls3();
    public static final List FB_STREAM_PERMISSIONS = new _cls4();
...
label0:
        {
            PLog.a("FB tryCloseFacebookSession", new Object[0]);
