    ...
    implements MarkerHolder, CachableImage
{
    ...
    public MapPin(Pin pin1)
    {
        ...
        } else
        {
            ...
            PLog.a((new StringBuilder("MapPin ")).append(latLng).append(" label: ").append(label).toString(), new Object[0]);
            return;
        }
    }
    ...
    private void setMarkerIcon(BitmapDescriptor bitmapdescriptor)
    {
        ...
        {
            bitmapdescriptor.printStackTrace();
        }
    }
    ...
    public void setImageBitmap(Bitmap bitmap)
    {
        ...
        {
            _rounded = new RoundedDrawable(bitmap, Resources.dimension(0x7f0a00c8));
            setImageBitmap();
        }
    }
