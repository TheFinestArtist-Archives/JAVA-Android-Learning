...
public class GoogleServiceDialog extends BaseDialog
{
    ...
    public GoogleServiceDialog()
    {
        ...
        {
            setTitle(0x7f0e0257);
            setMessage(0x7f0e0258);
            setPositiveButton(0x7f0e04d1, new _cls1());
            setNegativeButton(0x7f0e0315, new _cls2());
            return;
        } else
        {
            setTitle(0x7f0e0259);
            setMessage(0x7f0e025a);
            setPositiveButton(0x7f0e033b, new _cls3());
            return;
        }
    }
