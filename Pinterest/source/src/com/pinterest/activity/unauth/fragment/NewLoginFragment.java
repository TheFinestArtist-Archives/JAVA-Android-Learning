...
public class NewLoginFragment extends BaseFragment
{
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        bundle = new ImageView(getView().getContext());
        bundle.setScaleType(android.widget.ImageView.ScaleType.CENTER_CROP);
        bundle.setImageBitmap(BitmapFactory.decodeResource(getResources(), 0x7f020173));
        ...
        if (Preferences.persisted().getBoolean("BLOCK_SIGNUP", false))
        {
            ...
            ViewHelper.setVisibility(_notUserBtn, false);
            Application.showToast(0x7f0e047a);
        }
    }
...
*/
    ...
    private class GetProfileTask extends BackgroundTask
    {
        ...
        public void onFinish()
        {
            ...
            {
                _notUserBtn.setText(String.format(Resources.string(0x7f0e0472), new Object[] {
                    names[0]
                }));
                if (names.length > 1)
                {
