...
_L4:
    ...
    {
        LayoutInflater.from(context).inflate(0x7f03006a, this, true);
        ButterKnife.a(this);
...
_L14:
    ...
    static 
    {
        ...
        hashtable.put(AndroidEducationAnchor.EXPLORE_TAB, new PulseViewContext(0x7f0b030a, com/pinterest/activity/home/HomeFragment.getSimpleName(), 0.0F, 0.0F));
        UI_LOCATIONS.put(AndroidEducationAnchor.PIN_IMAGE_VIEW, new PulseViewContext(0x7f0b0007, com/pinterest/activity/pin/fragment/PinSwipeFragment.getSimpleName(), 0.0F, 0.0F));
        UI_LOCATIONS.put(AndroidEducationAnchor.NEWS_BUTTON, new PulseViewContext(0x7f0b0307, com/pinterest/activity/user/UserFragment.getSimpleName(), 0.0F, 0.0F));
        UI_LOCATIONS.put(AndroidEducationAnchor.PIN_IT_BUTTON, new PulseViewContext(0x7f0b01c8, com/pinterest/activity/pin/fragment/PinSwipeFragment.getSimpleName(), 0.0F, 0.0F));
        UI_LOCATIONS.put(AndroidEducationAnchor.BOARD_FOLLOW_BUTTON, new PulseViewContext(0x7f0b02b7, com/pinterest/activity/board/fragment/BoardFragment.getSimpleName(), 0.0F, 0.0F));
    }
    ...
    private class _cls4 extends android.view.GestureDetector.SimpleOnGestureListener
    {
        ...
        private float getLimitedDistance()
        {
            ...
            {
                return finalScrollDistance;
            } else
            {
                return _currScrollDistance;
            }
        }
...
_L4:
            PLog.a("onScroll %f", new Object[] {
                Float.valueOf(f1)
            });
            _currScrollDistance = getLimitedDistance();
