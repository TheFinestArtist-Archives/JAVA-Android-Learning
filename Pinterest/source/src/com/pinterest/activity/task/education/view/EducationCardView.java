...
public class EducationCardView extends RelativeLayout
{
    ...
    {
        LayoutInflater.from(context).inflate(0x7f030120, this, true);
        ButterKnife.a(this);
        _measured = false;
        _isLastStep = false;
...
_L4:
        ...
        View view = findViewById(0x7f0b02a8);
        if (view != null)
        {
...
_L2:
        ...
        byte0 = 10;
          goto _L4
        _cardDisplacementOp = 1;
        _cardDisplacement = -(int)Resources.dimension(0x7f0a0025);
    ...
    public void showSuccess(final com.pinterest.kit.utils.AnimationUtils.AnimationListener listener)
    {
        ...
        Object obj = findViewById(0x7f0b02a8);
        if (obj == null)
        {
            return;
        } else
