...
public class EducationBackgroundPageFragment extends BaseFragment
{
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        getResources().getValue(0x7f0a00ce, bundle, true);
        float f = bundle.getFloat();
        _imageView = (NonRoundWebImageView)view.findViewById(0x7f0b0039);
        _loadingSpinner = (LoadingView)view.findViewById(0x7f0b015a);
        _spinnerContainer = (FrameLayout)view.findViewById(0x7f0b0159);
