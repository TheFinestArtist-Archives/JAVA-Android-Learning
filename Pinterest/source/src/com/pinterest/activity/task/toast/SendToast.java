...
public class SendToast extends BaseToast
{
    ...
    private void actuallySend()
    {
        ...
        if (_item.getItemType() != com.pinterest.activity.search.model.TypeAheadItem.ItemType.EMAIL_CONTACT && _item.getItemType() != com.pinterest.activity.search.model.TypeAheadItem.ItemType.FACEBOOK_CONTACT) goto _L2; else goto _L1
_L1:
...
_L7:
    ...
    public View getView(ToastContainer toastcontainer)
    {
        ...
        if (_objectToSend.isPin())
        {
            setMessage(Resources.string(0x7f0e0370));
        } else
        if (_objectToSend.isBoard())
        {
            setMessage(Resources.string(0x7f0e0081));
        }
        setSecondaryMessage(Resources.string(0x7f0e04b1, new Object[] {
            _item.getTitle()
        }));
    ...
    private class SendPinResponseHandler extends BaseApiResponseHandler
    {
        ...
        {
            Application.forceShowToast(Resources.string(0x7f0e0447));
        }
    ...
    private class BoardSendResponseHandler extends BaseApiResponseHandler
    {
        ...
        public void onFailure(Throwable throwable, ApiResponse apiresponse)
        {
            Application.forceShowToast(Resources.string(0x7f0e0444));
        }
