...
public class EditFieldDialog extends BaseDialog
{
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        _editText = (EditText)findViewById(0x7f0b00c2);
        if (_hint != null)
        {
            _editText.setHint(_hint);
        }
        ViewHelper.setTextAndCursor(_editText, _prefilledText);
        _editText.setImeActionLabel(Resources.string(0x7f0e040b), 2);
        _editText.setOnEditorActionListener(new _cls1());
        setPositiveButton(0x7f0e033a, new _cls2());
    ...
    {
        _prefilledText = s;
        s = (EditText)findViewById(0x7f0b00c2);
        if (s != null)
        {
