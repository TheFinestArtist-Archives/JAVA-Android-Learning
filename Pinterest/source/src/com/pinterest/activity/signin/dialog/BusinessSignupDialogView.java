    ...
    implements android.view.View.OnClickListener
{
    ...
    {
        edittext.setBackgroundResource(0x7f02016d);
...
_L3:
    ...
    private void updateInput()
    {
        ...
        {
            _businessType.setText(0x7f0e0442);
        } else
        {
    ...
    private boolean validateAndSaveInput()
    {
        ...
        if (!SignupFormUtils.isBusinessNameValid(s2))
        {
            ...
            Application.showToast(0x7f0e045f);
            return false;
        }
        if (!SignupFormUtils.isBusinessTypeValid(lastSelectedTypeKey))
        {
            Application.showToast(0x7f0e0460);
            return false;
        } else
        {
            lastEmailInput = s;
    ...
    protected void init()
    {
        LayoutInflater.from(getContext()).inflate(0x7f030060, this, true);
        ButterKnife.a(this);
    ...
    void onAccountTypeClicked()
    {
        if (_types == null)
        {
            Application.showToast(0x7f0e0214);
            return;
        } else
        {
    ...
    void onSignupClicked()
    {
        ...
        } else
        {
            ...
            partnerparams.w = lastBusinessName;
            partnerparams.x = lastSelectedTypeKey;
            partnerparams.y = lastWebsite;
            partnerparams.s = _inviteCode;
    ...
    void onTosClicked()
    {
        ...
        ActivityHelper.goIntentView(getContext(), Resources.string(0x7f0e04e4));
    }
