...
public class EmailOnlyLoginDialog extends LoginDialog
{
    ...
    public void make(LayoutInflater layoutinflater)
    {
        ...
        ViewHelper.setVisibility(_customView.findViewById(0x7f0b00ce), 8);
        ViewHelper.setVisibility(_customView.findViewById(0x7f0b00cf), 0);
        layoutinflater = (TextView)_customView.findViewById(0x7f0b00d1);
        layoutinflater.setText(MyUser.getGPlusAccount());
        layoutinflater.setEnabled(false);
        layoutinflater = _customView.findViewById(0x7f0b00d2);
