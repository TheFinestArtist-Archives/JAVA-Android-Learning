...
_L4:
        LayoutInflater.from(getContext()).inflate(0x7f030054, this, true);
        _emailEditText = (EditText)findViewById(0x7f0b00ca);
        ...
        _submitButton = (Button)findViewById(0x7f0b00e4);
        _submitButton.setOnClickListener(this);
        setSubmitButtonEnabled(SignupFormUtils.isEmailValid(_emailEditText.getText().toString()));
        _loadingView = (LoadingView)findViewById(0x7f0b0075);
        return;
_L2:
        try
        {
