...
public class ResetPasswordDialog extends LoadingDialog
{
    ...
    private class _cls1 extends ApiResponseHandler
    {
        ...
        public void onFailure(Throwable throwable, ApiResponse apiresponse)
        {
            ...
            {
                throwable = Resources.string(0x7f0e0215);
            }
            apiresponse = new BaseDialog();
            apiresponse.setTitle(0x7f0e0034);
            ...
            apiresponse.setPositiveButton(0x7f0e045c, new _cls1());
            class _cls2
                implements android.view.View.OnClickListener
            {
            ...
            apiresponse.setNegativeButton(0x7f0e04b7, new _cls2());
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            apiresponse = new BaseDialog();
            apiresponse.setTitle(0x7f0e0034);
            apiresponse.setMessage(String.format(Resources.string(0x7f0e0407), new Object[] {
                _email
            }));
            class _cls3
                implements android.view.View.OnClickListener
            ...
            apiresponse.setPositiveButton(0x7f0e0406, new _cls3());
            Events.post(new DialogEvent(apiresponse));
        }
