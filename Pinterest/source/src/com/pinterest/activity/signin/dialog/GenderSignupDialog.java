...
public class GenderSignupDialog extends BaseDialog
{
    ...
    private void trySignup()
    {
        ...
        signupparams.o = _firstname;
        signupparams.p = _lastname;
        signupparams.b = "";
        signupparams.q = _email;
        signupparams.c = _password;
        if (_genderGp == null) goto _L2; else goto _L1
_L1:
        _genderGp.getCheckedRadioButtonId();
        JVM INSTR tableswitch 2131427526 2131427527: default 84
    //                   2131427526 181
    //                   2131427527 190;
           goto _L3 _L4 _L5
_L3:
...
_L9:
        String s;
        int i;
        _ageEt = (PEditText)findViewById(0x7f0b0101);
...
_L7:
        ...
        {
            _ageEt.setBackgroundResource(0x7f02016d);
            _ageEt.requestFocus();
            _ageEt.setSelection(s.length());
            Application.showToast(0x7f0e045e);
            return;
        }
        if (i >= 13)
        {
            SignupConfirmDialog signupconfirmdialog = new SignupConfirmDialog();
            signupparams.t = getUnixBirthdate(i);
...
_L8:
    ...
    public void make(LayoutInflater layoutinflater)
    {
        ...
        layoutinflater = (Button)gendersignupdialogview.findViewById(0x7f0b0102);
        _genderGp = (RadioGroup)gendersignupdialogview.findViewById(0x7f0b00fe);
