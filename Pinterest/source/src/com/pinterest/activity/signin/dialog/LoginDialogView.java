    ...
    implements android.view.View.OnClickListener
{
    ...
    private void init()
    {
        ...
        LayoutInflater.from(getContext()).inflate(0x7f03004b, this, true);
        _messageContainer = findViewById(0x7f0b00cf);
        ...
        _rakutenBt = findViewById(0x7f0b00d6);
        if (_rakutenBt != null)
        {
            _rakutenBt.setOnClickListener(this);
        }
        _forgotPassword = findViewById(0x7f0b00d3);
    ...
    private void onLoginFailure(Throwable throwable, ApiResponse apiresponse)
    {
        if (ApiResponse.ACCOUNT_FAILURE.contains(Integer.valueOf(apiresponse.getCode())) && SignupFormUtils.isEmailValid(lastEmailInput))
        {
            try
            {
                ...
                AccountApi.a(lastEmailInput, emailcheckresponsehandler);
                return;
            }
            catch (Exception exception)
            {
    ...
    private void showEmailSuggestionDialog(final String suggestedEmail)
    {
        ...
        basedialog.setTitle(0x7f0e0034);
        basedialog.setMessage(Resources.string(0x7f0e02ca, new Object[] {
            suggestedEmail
        }));
        basedialog.setPositiveButton(0x7f0e04ab, new _cls3());
        basedialog.setNegativeButton(0x7f0e04b7, new _cls4());
    ...
    private void showLoginRetryDialog(String s)
    {
        ...
        basedialog.setPositiveButton(0x7f0e04b7, new _cls5());
        basedialog.setNegativeButton(0x7f0e0268, new _cls6());
        Events.post(new DialogEvent(basedialog));
    }
    ...
    private void tryLogin()
    {
        ...
        if (StringUtils.isEmpty(s))
        {
            ...
            Application.showToast(0x7f0e02c9);
            return;
        }
        if (StringUtils.isEmpty(s1))
        {
            ...
            Application.showToast(0x7f0e02cd);
            return;
        } else
        {
...
label0:
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            view.c = LoginDialogView.lastPasswordInput;
