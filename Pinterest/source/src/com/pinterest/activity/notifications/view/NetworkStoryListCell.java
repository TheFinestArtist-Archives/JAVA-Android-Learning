    ...
    implements android.view.View.OnClickListener
{
    ...
    private static int sRelatedObjectsMaxCountLargeScreen = Resources.integer(0x7f0c0011).intValue();
    ...
    public static NetworkStoryListCell from(View view, ViewGroup viewgroup)
    {
        ...
        {
            return (NetworkStoryListCell)ViewHelper.viewById(ViewHelper.getContext(view, viewgroup), 0x7f0300ea);
        }
    }
    ...
    {
        if (i >= Resources.integer(0x7f0c0012).intValue())
        {
    ...
    public void onStoryClick(View view)
    {
        ...
        if (!_story.isPin()) goto _L2; else goto _L1
_L1:
...
_L11:
        ...
        k = (int)getResources().getDimension(0x7f0a0103);
        i = 0;
_L9:
        if (i >= Math.min(user.length, _relatedIv.length)) goto _L4; else goto _L3
_L3:
        android.widget.LinearLayout.LayoutParams layoutparams;
        _relatedIv[i] = new GrayWebImageView(getContext(), null, 0x7f0f01b3);
        layoutparams = new android.widget.LinearLayout.LayoutParams(k, k);
        layoutparams.setMargins(0, 0, (int)getResources().getDimension(0x7f0a0095), 0);
...
_L4:
        ...
        {
            user = new TextView(getContext(), null, 0x7f0f01ae);
            user.setTextColor(Colors.TEXT_LIGHT);
            user.setTextSize(0, Resources.dimension(0x7f0a00f6));
            ...
            user.setText((new StringBuilder()).append(Resources.string(0x7f0e03af)).append(String.valueOf(j - l)).toString());
...
_L10:
    ...
    public void showTimestamp(com.pinterest.activity.home.view.BaseNotificationListCell.CellPosition cellposition)
    {
        ...
        {
            cellposition = getContext().getString(0x7f0e04b3);
        } else
        {
            cellposition = (new SimpleDateFormat(getContext().getString(0x7f0e0496), Locale.getDefault())).format(cellposition.getTime()).toUpperCase();
        }
    ...
    static 
    {
        int i = Resources.integer(0x7f0c0013).intValue();
