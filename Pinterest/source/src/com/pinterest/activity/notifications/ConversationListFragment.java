...
label0:
    ...
    {
        _emptyLeftImage = 0x7f0201a4;
        _emptyRightImage = 0x7f0201a5;
        if (getView() != null)
        {
        ...
        _emptyActionLabel = Resources.string(0x7f0e01ed);
        _emptyMessage = Resources.string(0x7f0e01ee);
    }
...
// JavaClassFileOutputException: get_constant: invalid tag
    ...
    private class _cls7 extends com.pinterest.base.Events.EventsSubscriber
    {
        ...
        {
            PLog.a("ConversationListFragment.NagEvent", new Object[0]);
            if ( == null)
            {
                ((MegaphoneView)ViewHelper.viewById(getActivity(), 0x7f030100)). = nagevent;
                .setListViewParent(
// JavaClassFileOutputException: get_constant: invalid tag
