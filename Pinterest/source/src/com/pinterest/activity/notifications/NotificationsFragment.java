...
public class NotificationsFragment extends ViewPagerFragment
{
    ...
    private void updateUnreadBadge(Tab tab, Integer integer)
    {
        ...
        if (tab != null)
        {
            if (flag)
            {
                integer = Resources.drawable(0x7f0201b0);
            } else
            {
                integer = null;
            }
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _actionBar.setTitle(0x7f0e0024);
        _actionBarWrapper.setShadowVisibility(8);
        _tabBar = (TabBar)view.findViewById(0x7f0b0062);
        _tabBar.setMaxWidth((int)Resources.dimension(0x7f0a008d));
        _newsButton = (Tab)_tabBar.findViewById(0x7f0b0175);
        _yourStoryButton = (Tab)_tabBar.findViewById(0x7f0b0176);
        _conversationButton = (Tab)_tabBar.findViewById(0x7f0b0177);
        int i = getTabToShow();
        _tabBar.setCurrentIndex(i);
        _tabBar.setListener(_tabListener);
        _viewPager.setPageMargin((int)Resources.dimension(0x7f0a00a4));
