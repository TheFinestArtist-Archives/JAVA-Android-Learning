...
public class PeoplePickerListWrapper extends FrameLayout
{
    ...
    protected void onFinishInflate()
    {
        ...
        _listView = (SendPinListView)findViewById(0x7f0b0129);
        ...
        _searchHeaderEt = (EditText)_searchHeader.findViewById(0x7f0b014d);
    ...
    public void setObjectToSend(SendableObject sendableobject)
    {
        ...
        {
            _adapter.setTitle(0x7f0e0448);
            _adapter.setEmptySearchCellText(0x7f0e0205);
        } else
        if (sendableobject.isBoard())
        {
            _adapter.setTitle(0x7f0e0445);
            _adapter.setEmptySearchCellText(0x7f0e0204);
            return;
        }
    }
...
_L3:
            ...
            childDisplayRect.flattenToString();
            _headerDisplayRect.flattenToString();
    ...
    private class _cls6 extends com.pinterest.base.Events.EventsSubscriber
    {
        ...
        {
            SocialUtils.startShare(getContext(), _objectToSend, sendsocialevent.text, sendsocialevent.packageName);
        }

        public void onEventMainThread(com.pinterest.base.Social.UpdateEvent updateevent)
        {
            switch (_cls8..SwitchMap.com.pinterest.base.Social.Network[updateevent.getNetwork().ordinal()])
            {
            default:
                return;
        ...
        public void onItemClick(AdapterView adapterview, View view, int i, long l)
        {
            ...
            } else
            {
                ...
                if (adapterview instanceof TypeAheadItem)
                {
                    ...
                    switch (_cls8..SwitchMap.com.pinterest.activity.search.model.TypeAheadItem.ItemType[adapterview.getItemType().ordinal()])
                    {
                    default:
                        return;
