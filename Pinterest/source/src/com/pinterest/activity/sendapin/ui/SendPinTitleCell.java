...
public class SendPinTitleCell extends RelativeLayout
{
    ...
    public SendPinTitleCell(Context context, AttributeSet attributeset)
    {
        ...
        _messageHint = Resources.string(0x7f0e02f0);
        _msg = "";
    ...
    protected void onFinishInflate()
    {
        ...
        _titleTv = (TextView)findViewById(0x7f0b003d);
        _msgButton = (Button)findViewById(0x7f0b025b);
    ...
    public void setMessage(String s)
    {
        ...
        {
            _msgButton.setText(Resources.string(0x7f0e02f1));
        }
        _msg = s;
    }
