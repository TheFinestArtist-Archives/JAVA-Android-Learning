...
public class SendSocialView extends FrameLayout
{
    ...
    public void addChannel(final com.pinterest.activity.pin.adapter.IconTextListAdapter.IconText app)
    {
        ...
        listcellbasic.setText(Resources.string(0x7f0e044a, new Object[] {
            app.text
        }));
    ...
    public void addChannels(List list)
    {
        if (list != null)
        {
            ...
            while (list.hasNext()) 
            {
                addChannel((com.pinterest.activity.pin.adapter.IconTextListAdapter.IconText)list.next());
            }
        }
    }
        ...
        implements android.view.View.OnClickListener
    {
        ...
        final com.pinterest.activity.pin.adapter.IconTextListAdapter.IconText val$app;
