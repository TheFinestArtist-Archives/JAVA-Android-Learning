    ...
    implements ListAdapter
{
    ...
    public SendPinAdapter(Context context)
    {
        ...
        _stickyTitleCell = (SendPinTitleCell)_inflater.inflate(0x7f03010a, null);
        _stickyHeaders.put(1, _stickyTitleCell);
        Object obj = (ViewGroup)_inflater.inflate(0x7f030104, null);
        _stickySearchEt = (SearchEditText)((ViewGroup) (obj)).findViewById(0x7f0b014d);
        _stickySearchEt.setHint(0x7f0e04af);
        _stickyHeaders.put(2, obj);
        _shimView = new FrameLayout(context);
        _listViewHeaders.add(_shimView);
        _titleCell = (SendPinTitleCell)_inflater.inflate(0x7f03010a, null);
        _listViewHeaders.add(_titleCell);
        _searchView = (ViewGroup)_inflater.inflate(0x7f030104, null);
        _searchEt = (SearchEditText)_searchView.findViewById(0x7f0b014d);
        _searchEt.setHint(0x7f0e04af);
        _listViewHeaders.add(_searchView);
        _socialView = new SendSocialView(context);
        _listViewHeaders.add(_socialView);
        _emptySearchCell = (EmptySearchCell)_inflater.inflate(0x7f030109, null);
        ...
        ROW_HEIGHT = Math.round(context.getResources().getDimension(0x7f0a0092));
    }
...
_L3:
    ...
    {
        View view = ((ViewGroup)_listViewHeaders.get(2)).findViewById(0x7f0b014d);
