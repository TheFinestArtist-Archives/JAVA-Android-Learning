    ...
    implements Runnable
{
    ...
    public void run()
    {
        if (val$showSpinner)
        {
            ProgressSpinnerListCell progressspinnerlistcell = PeopleSearchAdapter.access$300(PeopleSearchAdapter.this);
            boolean flag;
            if (getCount() == 0)
            {
                flag = true;
        ...
        {
            PeopleSearchAdapter.access$300(PeopleSearchAdapter.this).hideSpinner();
            return;
        }
    }
