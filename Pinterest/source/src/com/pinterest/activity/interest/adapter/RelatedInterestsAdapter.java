...
public class RelatedInterestsAdapter extends PinterestBaseAdapter
{
    ...
    {
        _margin = (int)Resources.dimension(0x7f0a0098);
        _sideMargin = (int)Resources.dimension(0x7f0a0098);
        _cellSize = (int)Resources.dimension(0x7f0a0106);
        ...
        view.setImageCornerRadius((int)Resources.dimension(0x7f0a0069));
