...
public class InterestFragment extends CategoryFragment
{
    ...
    public InterestFragment()
    {
        ...
        Experiments.a("interests_feed_blended_pin_annotation_android");
        if (Experiments.k())
        {
    ...
    protected void loadData()
    {
        ...
        } else
        {
            ...
            InterestsApi.a(_interest.getUid(), onInterestLoaded, ApiFields.q);
            return;
        }
    }
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        view.setBackgroundColor(Resources.color(0x7f090047));
        _gridVw.addHeaderView(view, -1, (int)Resources.dimension(0x7f0a008c));
