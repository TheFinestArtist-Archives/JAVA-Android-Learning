...
public class RelatedInterestsView extends TwoWayView
{
    ...
    private void loadData()
    {
        ...
        InterestsApi.b(_contentId, _maxInterests, _lcls2, _apiTag);
    }
...
*/
        ...
        implements android.widget.AdapterView.OnItemClickListener
    {
        ...
        public void onItemClick(AdapterView adapterview, View view, int i, long l)
        {
            ...
            adapterview.put("interest", ((Interest)_interestsAdapter.getItem(i)).getUrlName());
            Pinalytics.a(ElementType.FLOWED_INTEREST, ComponentType.INTEREST_RELATED_CAROUSEL, adapterview);
            adapterview = (Interest)_interestsAdapter.getItem(i);
