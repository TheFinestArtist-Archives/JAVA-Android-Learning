    ...
    implements android.widget.Listener
{
    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        adapterview.put("interest", ((Interest)RelatedInterestsView.access$000(RelatedInterestsView.this).getItem(i)).getUrlName());
        Pinalytics.a(ElementType.FLOWED_INTEREST, ComponentType.INTEREST_RELATED_CAROUSEL, adapterview);
        adapterview = (Interest)RelatedInterestsView.access$000(RelatedInterestsView.this).getItem(i);
