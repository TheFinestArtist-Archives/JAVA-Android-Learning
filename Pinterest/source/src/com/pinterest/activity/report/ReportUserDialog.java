...
_L4:
        _user = ((User) (obj));
        setTitle(Resources.string(0x7f0e03f1));
...
_L3:
    ...
    private void showReportOtherReasonDialog()
    {
        ...
        {
            dialog.setHint(Resources.string(0x7f0e03f6, new Object[] {
                _user.getFirstName()
            }));
        }
...
_L6:
    ...
    private class _cls4 extends ApiResponseHandler
    {
        ...
        public void onFailure(Throwable throwable, ApiResponse apiresponse)
        {
            ...
            {
                Application.showToast(Resources.string(0x7f0e0400, new Object[] {
                    _user.getFullName()
                }));
                return;
            }
        ...
        public void onStart()
        {
            if (_user.getFullName() != null)
            {
                Events.post(new DialogEvent(new LoadingDialog(String.format(Resources.string(0x7f0e0401), new Object[] {
                    _user.getFullName()
                }))));
            }
        }
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            if (_user.getFullName() != null)
            {
                Application.showToast(Resources.string(0x7f0e0402, new Object[] {
                    _user.getFullName()
                }));
            }
        }
