...
public class ReportConversationDialog extends BaseDialog
{
    ...
    public ReportConversationDialog()
    {
        ...
        _reportReasons = Arrays.asList(Resources.stringArray(0x7f07002a));
...
_L3:
    ...
    private class _cls3 extends ApiResponseHandler
    {
        ...
        {
            Application.showToast(Resources.string(0x7f0e03ed));
        }
        ...
        public void onStart()
        {
            Events.post(new DialogEvent(new LoadingDialog(Resources.string(0x7f0e03ef))));
        }

        public void onSuccess(ApiResponse apiresponse)
        {
            Application.showToast(Resources.string(0x7f0e03f0));
