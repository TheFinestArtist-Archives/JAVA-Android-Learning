    ...
    implements Scrollable
{
    ...
    void onMakePublicClicked()
    {
        Events.post(new DialogEvent(BoardBaseDialog.newInstance(com/pinterest/activity/board/dialog/BoardMakePublicDialog, _board.getUid())));
    }
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _actionBar.setTitle(0x7f0e0074);
        initUi(view);
    }
