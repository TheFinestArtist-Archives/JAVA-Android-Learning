    ...
    public void onFinish()
    {
        ...
        if (view != null)
        {
            if (invite != null && invite.getStatus().equals("new"))
            {
                ...
                {
                    _inviteHeader = (BoardHeaderInviteView)LayoutInflater.from(view.getContext()).inflate(0x7f03011b, BaseBoardFragment.access$100(BaseBoardFragment.this), false);
                    _inviteHeader.setApiTag(BaseBoardFragment.access$200(BaseBoardFragment.this));
                    BaseBoardFragment.access$100(BaseBoardFragment.this).addView(_inviteHeader);
                }
