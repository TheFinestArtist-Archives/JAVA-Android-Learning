...
public class LeaveBoardDialog
{
    ...
    public static void show(final Activity activity, final Board board)
    {
        ...
        dialog.setTitle(0x7f0e02b6);
        dialog.setMessage(0x7f0e02b7);
        dialog.setPositiveButton(0x7f0e02b4, new _cls1());
...
label0:
                {
                    ...
                    if (_board != null)
                    {
                        ...
                        Application.showToastShort(Resources.string(0x7f0e02ba));
