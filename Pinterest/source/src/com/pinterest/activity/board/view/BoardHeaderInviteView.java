    ...
    implements android.view.View.OnClickListener
{
    ...
    public BoardHeaderInviteView(Context context, AttributeSet attributeset)
    {
        ...
        onAccepted = new _cls2(0x7f0e0020);
        onIgnored = new _cls3(0x7f0e0290);
        init();
    }
    ...
    private void init()
    {
        ...
        _inviterItv = (PinIconTextView)findViewById(0x7f0b01bf);
        _inviterItv.setPaddingDimen(0x7f0a0098);
        _inviterItv.setOval(true);
        _ignoreBtn = (Button)findViewById(0x7f0b01c0);
        _acceptBtn = (Button)findViewById(0x7f0b01c1);
    }

    private void showAcceptDialog()
    {
        final BaseDialog dialog = new BaseDialog();
        dialog.setTitle(0x7f0e001f);
        dialog.setMessage(0x7f0e001e);
        dialog.setPositiveButton(0x7f0e001c, new _cls1());
    ...
    public void setInviter(User user)
    {
        ...
        {
            android.text.Spanned spanned = ViewHelper.getBoldText(0x7f0e0078, user.getFirstName());
