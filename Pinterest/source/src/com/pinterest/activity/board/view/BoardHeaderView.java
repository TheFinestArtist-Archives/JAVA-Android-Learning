...
public class BoardHeaderView extends LinearLayout
{
    ...
    {
        setOrientation(1);
        setBackgroundResource(0x7f09000a);
        inflate(getContext(), 0x7f0300c0, this);
        ButterKnife.a(this);
    ...
    private void showCollaboratorImages(UserFeed userfeed)
    {
        if (userfeed != null && userfeed.getCount() != 0)
        {
            ...
            i1 = (int)getResources().getDimension(0x7f0a0103);
            for (int k = 0; k < i; k++)
            {
                agraywebimageview[k] = new GrayWebImageView(getContext(), null, 0x7f0f01b3);
            ...
            if (_board.getCollaboratorCount().intValue() + 1 > 3)
            {
                ...
                userfeed.setTextAppearance(getContext(), 0x7f0f0133);
    ...
    private void updateCollaborators()
    {
        if (Constants.isTrue(_board.getCollaborative()))
        {
            ...
            loadCollaborators();
            ViewHelper.setLeftDrawable(_infoTv, 0x7f020116);
            setVisibility(0);
            return;
        }
...
_L8:
    ...
    public void onMapStateChanged(com.pinterest.activity.board.fragment.BoardFragment.BoardMapState boardmapstate)
    {
        _cls4..SwitchMap.com.pinterest.activity.board.fragment.BoardFragment.BoardMapState[boardmapstate.ordinal()];
...
_L4:
    ...
    private class _cls4
    {
        ...
        static final int $SwitchMap$com$pinterest$activity$board$fragment$BoardFragment$BoardMapState[];

        static 
        {
            $SwitchMap$com$pinterest$activity$board$fragment$BoardFragment$BoardMapState = new int[com.pinterest.activity.board.fragment.BoardFragment.BoardMapState.values().length];
            try
            {
                $SwitchMap$com$pinterest$activity$board$fragment$BoardFragment$BoardMapState[com.pinterest.activity.board.fragment.BoardFragment.BoardMapState.OPEN.ordinal()] = 1;
            }
            catch (NoSuchFieldError nosuchfielderror1) { }
            try
            {
                $SwitchMap$com$pinterest$activity$board$fragment$BoardFragment$BoardMapState[com.pinterest.activity.board.fragment.BoardFragment.BoardMapState.CLOSED.ordinal()] = 2;
            }
