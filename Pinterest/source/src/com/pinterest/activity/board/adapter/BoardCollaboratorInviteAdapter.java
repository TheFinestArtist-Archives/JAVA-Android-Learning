    ...
    implements ListAdapter
{
    ...
    private void appendEmailPlaceHolder()
    {
        ...
        typeaheaditem.setTitle(Resources.string(0x7f0e01d2, new Object[] {
            _currentSearchQuery
        }));
    ...
    private void fillView(PeoplePickerPersonCell peoplepickerpersoncell, CollaboratorInvite collaboratorinvite)
    {
        ...
        if (collaboratorinvite.getInviteBy() != null)
        {
            ...
            {
                String s = Resources.string(0x7f0e02a4, new Object[] {
                    user.getFirstName()
                });
                if (user.getUid().equals(MyUser.getUid()))
                {
                    s = Resources.string(0x7f0e02a5);
                }
            ...
            {
                peoplepickerpersoncell.setActionButton(Resources.string(0x7f0e03dc), new _cls1());
                return;
            }
            if (invitedUser.getUid().equals(MyUser.getUid()))
            {
                peoplepickerpersoncell.setActionButton(Resources.string(0x7f0e02b4), new _cls2());
                return;
            }
        }
    }
    ...
    private void fillView(PeoplePickerPersonCell peoplepickerpersoncell, final TypeAheadItem item)
    {
        ...
        {
            peoplepickerpersoncell.setActionButtonStyle(com.pinterest.ui.text.PButton.ButtonStyle.PLAIN);
            peoplepickerpersoncell.setActionButton(Resources.string(0x7f0e029b), new _cls3());
            return;
        } else
        {
            peoplepickerpersoncell.setActionButton(null, null);
    ...
    {
        params = new Bundle();
        params.putString("message", String.format(Resources.string(0x7f0e0077), new Object[] {
            MyUser.get().getFullName(), _board.getName()
        }));
        params.putString("title", _context.getString(0x7f0e0045));
    ...
    private void showRemoveCollaboratorDialog(final User invitedUser)
    {
        ...
        if (s != null && s1 != null)
        {
            final RemoveCollaboratorDialog dialog = new RemoveCollaboratorDialog(invitedUser);
            dialog.setPositiveButton(0x7f0e03e2, new _cls8());
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        if (view == null)
        {
            view = (PeoplePickerPersonCell)_li.inflate(0x7f0300ed, null);
        } else
        {
        ...
        implements android.view.View.OnClickListener
    {
        ...
        private class BoardCollaboratorInviteResponseHandler extends ApiResponseHandler
        {
            ...
            public void onSuccess(ApiResponse apiresponse)
            {
                ...
                Events.post(new ToastEvent(new UserToast(Resources.string(0x7f0e007b), _item.getTitle(), _item.getImageUri())));
                refreshBoardCollaborators();
            }
                ...
                public void run()
                {
                    if (query.equalsIgnoreCase(_currentSearchQuery))
                    {
                        if (apiItems.isEmpty())
                        {
                            ...
                            typeaheaditem.setTitle(Resources.string(0x7f0e0310));
        ...
        implements com.facebook.widget.WebDialog.OnCompleteListener
    {
        ...
        public void onComplete(Bundle bundle, FacebookException facebookexception)
        {
            if (facebookexception != null)
            {
                ...
                {
                    Application.showToast(0x7f0e0079);
                } else
                {
