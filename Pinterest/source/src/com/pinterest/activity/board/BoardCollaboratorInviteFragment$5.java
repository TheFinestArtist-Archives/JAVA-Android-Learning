    ...
    public void onItemClick(AdapterView adapterview, View view, int i, long l)
    {
        ...
        if (adapterview != null)
        {
            ...
            if (adapterview instanceof TypeAheadItem)
            {
                ...
                {
                    adapterview = BoardCollaboratorInviteFragment.access$000(BoardCollaboratorInviteFragment.this).getText().toString();
                    if (SignupFormUtils.isEmailValid(adapterview))
                    {
                        Device.hideSoftKeyboard(BoardCollaboratorInviteFragment.access$000(BoardCollaboratorInviteFragment.this));
                        Events.post(new ToastEvent(new InviteEmailToast(BoardCollaboratorInviteFragment.access$300(BoardCollaboratorInviteFragment.this), adapterview)));
                        return;
                    } else
                    {
