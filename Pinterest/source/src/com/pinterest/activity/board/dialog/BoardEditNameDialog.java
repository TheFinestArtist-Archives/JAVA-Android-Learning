...
public class BoardEditNameDialog extends OneFieldBaseDialog
{
    ...
    {
        return Resources.string(0x7f0e01ae);
    }

    protected String getHint()
    {
        return Resources.string(0x7f0e0145);
    }
    ...
    {
        return Resources.string(0x7f0e02f2);
    }
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            if (_board != null)
            {
                if ((apiresponse = ((ApiResponse) (apiresponse.getData()))) instanceof PinterestJsonObject)
                {
                    ...
                    Application.showToastShort(Resources.string(0x7f0e0301, new Object[] {
                        _board.getName()
                    }));
