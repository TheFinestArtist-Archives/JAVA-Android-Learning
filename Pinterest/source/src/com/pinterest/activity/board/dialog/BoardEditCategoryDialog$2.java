...
class this._cls0 extends ApiResponseHandler
{
    ...
    {
        Application.showToastShort(0x7f0e0067);
    }

    public void onSuccess(ApiResponse apiresponse)
    {
        super.onSuccess(apiresponse);
        Application.showToastShort(Resources.string(0x7f0e02fd, new Object[] {
            BoardEditCategoryDialog.access$100(BoardEditCategoryDialog.this)
        }));
