...
_L2:
        ...
        if ((!Experiments.p() || itemType != ItemType.PIN && itemType != ItemType.PIN_LOCAL_CACHE) && itemType != ItemType.NONE && ((GuidedSearchTypeAheadItem) (obj)).itemType != ItemType.NONE)
        {
...
_L4:
    ...
    public void setItem(PinterestJsonObject pinterestjsonobject)
    {
        ...
        JVM INSTR tableswitch 1 7: default 280
    //                   1 60
    //                   2 60
    //                   3 60
    //                   4 60
...
_L3:
        ...
        if (pinterestjsonobject == null) goto _L1; else goto _L6
_L6:
