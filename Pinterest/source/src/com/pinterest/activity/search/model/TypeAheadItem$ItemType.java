...
public final class  extends Enum
{
    ...
    static 
    {
        ...
        PHONE_CONTACT = new <init>("PHONE_CONTACT", 11);
        PINNER = new <init>("PINNER", 12);
        MUTUAL_FOLLOW = new <init>("MUTUAL_FOLLOW", 13);
        FOLLOWEE = new <init>("FOLLOWEE", 14);
        BOARD = new <init>("BOARD", 15);
        CONVERSATION = new <init>("CONVERSATION", 16);
        NONE = new <init>("NONE", 17);
        $VALUES = (new .VALUES[] {
