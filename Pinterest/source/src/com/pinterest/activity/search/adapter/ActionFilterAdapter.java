...
public class ActionFilterAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        view = GuidedSearchFilterCell.from(view, viewgroup);
        viewgroup = getItem(i);
        view.setTitleOnly(false);
        view.setText(viewgroup.getDisplayName());
        view.setCount(viewgroup.getDisplayCount());
        if (StringUtils.isNotEmpty(viewgroup.getSmallIconUrl()))
        {
            view.setIconVisibility(0);
            view.loadIconImage(viewgroup.getSmallIconUrl());
            return view;
        } else
        {
            view.setIconVisibility(8);
            return view;
        }
    }
