...
_L1:
        ...
        view = "PIN";
_L7:
        SearchApi.d(guidedsearchtypeaheaditem.getTitle(), view, new leteRecentQueryApiResponse(GuidedSearchTypeAheadAdapter.this, null), GuidedSearchTypeAheadAdapter.access$900(GuidedSearchTypeAheadAdapter.this));
