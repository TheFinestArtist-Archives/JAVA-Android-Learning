...
public class GuidedMyPinSearchFragment extends GuidedPinFragment
{
    ...
    private static int BOARD_ITEM_PADDING = (int)Resources.dimension(0x7f0a009b);
    private static int SCROLLVIEW_PADDING = (int)Resources.dimension(0x7f0a0098);
    ...
    protected void loadData()
    {
        ...
        {
            updateEmptyContent();
            SearchApi.a(_lastQuery, "default", true, onAllBoardsLoaded, getApiTag());
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _boardDividerView.setText(0x7f0e051f);
        ...
        _pinDividerView.setText(0x7f0e0520);
