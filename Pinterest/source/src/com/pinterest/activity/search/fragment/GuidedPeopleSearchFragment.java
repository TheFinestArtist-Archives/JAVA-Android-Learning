...
public class GuidedPeopleSearchFragment extends PeopleListFragment
{
    ...
    public void onCreate(Bundle bundle)
    {
        ...
        _layoutId = 0x7f03009b;
    }

    public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
    {
        layoutinflater = super.onCreateView(layoutinflater, viewgroup, bundle);
        viewgroup = LayoutInflater.from(getActivity()).inflate(0x7f030131, null);
        _nagView = (SearchNagView)viewgroup.findViewById(0x7f0b02c5);
        _nagVwEmpty = (SearchNagView)layoutinflater.findViewById(0x7f0b0189);
...
label0:
    ...
    {
        _emptyLeftImage = 0x7f020160;
        _emptyCenterImage = 0x7f020161;
        _emptyRightImage = 0x7f020162;
        _emptyMessage = Resources.string(0x7f0e0206, new Object[] {
            _lastQuery
        });
    }
