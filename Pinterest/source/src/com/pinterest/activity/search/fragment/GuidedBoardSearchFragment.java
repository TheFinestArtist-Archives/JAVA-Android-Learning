...
_L2:
        return;
_L3:
        SearchApi.a(_lastQuery, "default", false, onAllBoardsLoaded, getApiTag());
        return;
_L4:
        SearchApi.a(_lastQuery, "places", false, onPlaceBoardsLoaded, getApiTag());
        return;
    }
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _tabBar = (TabBar)((ViewGroup)_gridVw.addHeaderView(0x7f030129)).findViewById(0x7f0b02b9);
        bundle = (Tab)_tabBar.findViewById(0x7f0b02ba);
        Tab tab = (Tab)_tabBar.findViewById(0x7f0b02bb);
        bundle.setText(Resources.string(0x7f0e002e));
        tab.setText(Resources.string(0x7f0e0392));
...
_L1:
            if (k < 0)
            {
                ...
                _categoryListWrapper.setTranslationY(i);
            }
_L4:
            _oldY = j;
            return;
