...
public class 
{
    ...
    {
        guidedsearchactionfiltergridcell._filterImage = (SquareImageView)idcell._filterImage(obj, 0x7f0b01da, "field '_filterImage'");
        guidedsearchactionfiltergridcell._filterTextView = (TextView)idcell._filterTextView(obj, 0x7f0b01db, "field '_filterTextView'");
    }
