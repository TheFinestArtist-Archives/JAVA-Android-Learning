...
public class 
{
    ...
    public static void inject(butterknife.erCell ercell, GuidedSearchFilterCell guidedsearchfiltercell, Object obj)
    {
        ...
        guidedsearchfiltercell._countView = (TextView)ercell._countView(obj, 0x7f0b01d9, "field '_countView'");
        guidedsearchfiltercell._icon = (WebImageView)ercell._icon(obj, 0x7f0b01d8, "field '_icon'");
    }
