...
label0:
        ...
        GuidedSearchBar.access$300(GuidedSearchBar.this).setText("");
        GuidedSearchBar.access$300(GuidedSearchBar.this).setHint("");
        ...
        Events.post(new GuidedSearchEvent(getCurrentTokenQuery(false), GuidedSearchBar.access$400(GuidedSearchBar.this)));
        return true;
    }
