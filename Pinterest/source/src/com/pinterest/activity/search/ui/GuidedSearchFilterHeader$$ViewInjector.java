...
public class 
{
    ...
    {
        guidedsearchfilterheader._topCategoryTitle = (SolidTitleDivider)header._topCategoryTitle(obj, 0x7f0b00eb, "field '_topCategoryTitle'");
        guidedsearchfilterheader._optionsGv = (GridView)header._optionsGv(obj, 0x7f0b00ec, "field '_optionsGv'");
    }
