...
public class 
{
    ...
    public static void inject(butterknife.Filter filter, GuidedSearchModeFilter guidedsearchmodefilter, Object obj)
    {
        ...
        guidedsearchmodefilter._divider = (LinearLayout)filter._divider(obj, 0x7f0b0210, "field '_divider'");
        guidedsearchmodefilter._tokenIcon = (ImageView)filter._tokenIcon(obj, 0x7f0b020e, "field '_tokenIcon'");
    }
