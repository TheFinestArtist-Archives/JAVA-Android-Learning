...
public class GuidedSearchBar extends RelativeLayout
{
    ...
    private static final int BAR_PADDING_LEFT_WITHOUT_ICON = (int)Resources.dimension(0x7f0a00e3);
    private static final int BAR_PADDING_LEFT_WITH_ICON = (int)Resources.dimension(0x7f0a00df);
    private static final int BAR_PADDING_RIGHT = (int)Resources.dimension(0x7f0a00e1);
    private static final Set CONJUNCTIONS = new HashSet(Arrays.asList(Resources.stringArray(0x7f07002f)));
    private static final int QUERY_TEXT_PADDING = (int)Resources.dimension(0x7f0a009b);
    ...
    private void clearTokens(boolean flag)
    {
        int i = _searchEt.getChildCount();
    ...
    {
        final GuidedSearchTokenView tokenView = (GuidedSearchTokenView)_inflater.inflate(0x7f030108, this, false);
    ...
    private void init()
    {
        ...
        _searchEt = (LinearLayout)findViewById(0x7f0b005c);
        _queryText = (EditText)findViewById(0x7f0b005d);
        ...
        _userIcon = (GrayWebImageView)findViewById(0x7f0b005e);
        _searchIcon = Resources.drawable(0x7f020143);
        ...
        _searchRightIcon = (ImageView)findViewById(0x7f0b005f);
        _searchRightIcon.setOnClickListener(new _cls4());
        _tokenScrollable = (HorizontalScrollView)findViewById(0x7f0b005b);
        _focusView = findViewById(0x7f0b005a);
        SearchApi.a(_apiTag);
    }
...
_L1:
        ...
        } else
        {
            ...
            while (i < _queryMetaList.size()) 
            {
                ...
                if (querymetadata.getType() == com.pinterest.activity.search.model.QueryMetaData.ContextType.AUTO_COMPLETE)
                {
...
_L1:
    ...
    public void setUser(User user)
    {
        if (user != null)
        {
            ...
            _searchHint = Resources.string(0x7f0e042c);
        ...
        } else
        {
            ...
            ViewHelper.setVisibility(_userIcon, 8);
            _searchHint = Resources.string(0x7f0e041d);
            _searchScope = SearchScope.GLOBAL_SEARCH;
        }
        _queryText.setHint(_searchHint);
    }
...
/*
    static int access$1102(GuidedSearchBar guidedsearchbar, int i)
    {
...
/*
    static List access$1202(GuidedSearchBar guidedsearchbar, List list)
    {
...
/*
    static String access$802(GuidedSearchBar guidedsearchbar, String s)
    {
...
label0:
            ...
            Pinalytics.a(EventType.TAP, ElementType.SEARCH_BOX_TEXT_INPUT, ComponentType.SEARCH_BOX, null, keyevent);
