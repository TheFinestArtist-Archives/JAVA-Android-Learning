    ...
    implements ListAdapter
{
    ...
    public PlacePickerAdapter(Context context)
    {
        ...
        _lastCachedLocation = LocationProvider.getLastLocation(context);
    ...
    {
        int j = getCount();
        if (j > 1 || j == 1 && ((Place)getItem(0)).getUid() != null)
        {
            return i != j - 1 ? 0 : 1;
        } else
        {
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        if (getItemViewType(i) == 1)
        {
            if (view == null)
            {
                view = (LinearLayout)_li.inflate(0x7f0300e9, null);
                view.setBackgroundResource(0);
                ((WebImageView)view.findViewById(0x7f0b0039)).setImageResource(0x7f02013c);
                return view;
            }
        } else
        {
            ...
            if (obj == null)
            {
                viewgroup = (ListCellTwoLinesText)_li.inflate(0x7f0300f5, viewgroup, false);
            } else
            {
