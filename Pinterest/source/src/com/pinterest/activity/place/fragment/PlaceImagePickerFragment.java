...
public class PlaceImagePickerFragment extends PinterestGridFragment
{
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _actionBar.setTitle(0x7f0e00bd);
        view = _gridVw.addHeaderView(0x7f03013c);
        if (_place != null)
        {
            ((TextView)view.findViewById(0x7f0b012c)).setText(_place.getName());
            ((TextView)view.findViewById(0x7f0b02d3)).setText(_place.getAddress());
        }
        _gridVw.setOnItemClickListener(new _cls1());
        if (_emptyView != null)
        {
            _emptyView.setEnabled(true);
            _emptyView.setCenterIcon(0x7f020134);
            _emptyView.setMessage(0x7f0e01ff);
        }
    }
