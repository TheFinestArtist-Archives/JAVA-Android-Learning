...
public class _cls1
{
    ...
    {
        target._userIv = (GrayWebImageView)w.iew(obj, 0x7f0b029c, "field '_userIv'");
        target._usernameTv = (TextView)w._usernameTv(obj, 0x7f0b029b, "field '_usernameTv'");
        target._divider = w._divider(obj, 0x7f0b0056, "field '_divider'");
        w = w._divider(obj, 0x7f0b029d, "field '_updatePictureTv' and method 'onUpdatePictureClicked'");
