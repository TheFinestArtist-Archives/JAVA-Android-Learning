...
public class _cls1
{
    ...
    {
        target._tabBar = (TabBar)t._tabBar(obj, 0x7f0b0062, "field '_tabBar'");
        target._userHeader = (LinearLayout)t._userHeader(obj, 0x7f0b0197, "field '_userHeader'");
        target._userHeaderView = (UserHeaderView)t.aderView(obj, 0x7f0b0198, "field '_userHeaderView'");
        ...
        t.t(obj, 0x7f0b02e8, "method 'onUserImageClicked'").setOnClickListener(new _cls1());
    }
