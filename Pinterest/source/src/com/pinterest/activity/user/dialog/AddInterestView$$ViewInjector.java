...
public class 
{
    ...
    {
        addinterestview._searchEt = (SearchEditText)restview._searchEt(obj, 0x7f0b0094, "field '_searchEt'");
        addinterestview._listView = (ListView)restview._listView(obj, 0x7f0b0095, "field '_listView'");
        addinterestview._divider = restview._divider(obj, 0x7f0b0056, "field '_divider'");
    }
