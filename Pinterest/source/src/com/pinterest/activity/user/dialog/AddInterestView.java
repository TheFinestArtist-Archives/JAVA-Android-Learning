...
public class AddInterestView extends LinearLayout
{
    ...
    {
        setOrientation(1);
        inflate(getContext(), 0x7f03003b, this);
        ButterKnife.a(this);
        ...
        _searchEt.setHint(Resources.string(0x7f0e0501));
    ...
    {
        ViewGroup viewgroup = (ViewGroup)LayoutInflater.from(getContext()).inflate(0x7f0300fe, _listView, false);
        _footerVw = (AdapterFooterView)viewgroup.findViewById(0x7f0b0122);
