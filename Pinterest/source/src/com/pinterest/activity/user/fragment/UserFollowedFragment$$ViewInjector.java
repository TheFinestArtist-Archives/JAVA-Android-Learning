...
public class _cls3
{
    ...
    {
        target._swipeVw = (SwipeRefreshLayout)edfragment._swipeVw(obj, 0x7f0b013d, "field '_swipeVw'");
        target._scrollVw = (ObservableScrollView)edfragment.w(obj, 0x7f0b01a2, "field '_scrollVw'");
        target._emptyVw = (AdapterEmptyView)edfragment._emptyVw(obj, 0x7f0b01a3, "field '_emptyVw'");
        target._contentVw = (LinearLayout)edfragment._contentVw(obj, 0x7f0b01a4, "field '_contentVw'");
        target._userMetadataView = (UserMetadataView)edfragment.ew(obj, 0x7f0b01a5, "field '_userMetadataView'");
        target._followedBoards = (UserFollowedBoardsView)edfragment.ardsView(obj, 0x7f0b01a7, "field '_followedBoards'");
        target._followedInterests = (UserFollowedInterestsView)edfragment.terestsView(obj, 0x7f0b01a9, "field '_followedInterests'");
        target._followedPinners = (UserFollowedPinnersView)edfragment.nnersView(obj, 0x7f0b01ab, "field '_followedPinners'");
        View view = edfragment.nnersView(obj, 0x7f0b01a6, "field '_seeAllBoardsBt' and method 'onSeeAllBoardsClick'");
        ...
        view = edfragment.edFragment(obj, 0x7f0b01a8, "field '_seeAllInterestsBt' and method 'onSeeAllInterestsClick'");
        ...
        edfragment = edfragment.edFragment(obj, 0x7f0b01aa, "field '_seeAllPinnersBt' and method 'onSeeAllPinnersClick'");
