    ...
    implements UserBaseFragment, SynchronizedPagerChild
{
    ...
    protected void loadData()
    {
        ...
        {
            UserApi.b(s, new com.pinterest.api.remote.PinApi.PinFeedApiResponse(gridResponseHandler), getApiTag());
        }
        super.loadData();
    }
    ...
    protected void updateEmptyContent()
    {
        ...
        {
            _emptyMessage = Resources.string(0x7f0e01fa);
            return;
        }
        if (_user != null && !TextUtils.isEmpty(_user.getFirstName()))
        {
            _emptyMessage = Resources.string(0x7f0e01eb, new Object[] {
                _user.getFirstName()
            });
            return;
        } else
        {
            _emptyMessage = Resources.string(0x7f0e01ec);
            return;
        }
    }
}
