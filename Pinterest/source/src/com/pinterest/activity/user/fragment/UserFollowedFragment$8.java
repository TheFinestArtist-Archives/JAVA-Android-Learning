...
class this._cls0 extends com.pinterest.base.
{
    ...
    public void onEventMainThread(agment.UpdateEvent updateevent)
    {
        ...
        {
            InterestsApi.a(UserFollowedFragment.access$600(UserFollowedFragment.this).getId(), 8, UserFollowedFragment.access$300(UserFollowedFragment.this), UserFollowedFragment.access$700(UserFollowedFragment.this));
        }
    }
