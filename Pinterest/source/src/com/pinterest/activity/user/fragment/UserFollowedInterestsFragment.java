...
label0:
        ...
        {
            ((Interest)((InterestsGridAdapter)_adapter).getItem(i)).setFollowing(Boolean.valueOf(true));
        }
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _actionBar.setTitle(0x7f0e0236);
        updateEmptyContent();
    }
    ...
    protected void updateEmptyContent()
    {
        if (MyUser.isUserMe(_user))
        {
            _emptyMessage = Resources.string(0x7f0e01f4);
            return;
        } else
        {
            _emptyMessage = Resources.string(0x7f0e01e1, new Object[] {
                _user.getFirstName()
            });
            return;
        }
