    ...
    implements UserBaseFragment, SynchronizedPagerChild
{
    ...
    private User _user;
    UserMetadataView _userEmptyMetadataView;
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        if (_swipeVw != null)
        {
            ...
            int i = (int)Resources.dimension(0x7f0a0107) + Constants.MARGIN;
    ...
    protected void updateEmptyContent()
    {
        ...
        {
            _emptyMessage = Resources.string(0x7f0e01f6);
            return;
        }
        if (_user != null && !TextUtils.isEmpty(_user.getFirstName()))
        {
            _emptyMessage = Resources.string(0x7f0e01e3, new Object[] {
                _user.getFirstName()
            });
            return;
        } else
        {
            _emptyMessage = Resources.string(0x7f0e01e4);
            return;
        }
    }
