...
public class UserAboutBioView extends LinearLayout
{
    ...
    private static final int ABOUT_BOTTOM_PADDING = (int)Resources.dimension(0x7f0a0098);
    ...
    private void init()
    {
        ...
        _info = findViewById(0x7f0b00e7);
        _userBio = (TextView)findViewById(0x7f0b02d8);
        _userLocation = (TextView)findViewById(0x7f0b02d9);
        _btContainer = findViewById(0x7f0b0245);
        _addTv = (TextView)findViewById(0x7f0b02da);
    }
    ...
    private void showEditUserDialog()
    {
        ...
        {
            EditUserDialog edituserdialog = new EditUserDialog(_user.getAbout(), _user.getLocation());
...
_L2:
        ...
        {
            ViewHelper.showIconForLongText((TextView)findViewById(0x7f0b029a), 0x7f020108);
...
_L3:
        ...
        if (MyUser.isUserMe(user.getUid()))
        {
            _addTv.setText(Constants.appendEllipsis(0x7f0e0512));
