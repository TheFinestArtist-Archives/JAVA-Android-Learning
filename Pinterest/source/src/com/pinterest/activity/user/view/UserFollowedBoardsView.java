...
public class UserFollowedBoardsView extends AdapterLinearLayout
{
    ...
    protected android.widget.LinearLayout.LayoutParams createChildViewLayoutParams(View view, int i)
    {
        ...
        {
            i = (int)getResources().getDimension(0x7f0a00b1);
        }
    ...
    protected void updateView()
    {
        ...
        {
            s = com.pinterest.kit.application.Resources.string(0x7f0e01f3);
        } else
        {
            s = com.pinterest.kit.application.Resources.string(0x7f0e01e0, new Object[] {
                _user.getFirstName()
            });
        }
