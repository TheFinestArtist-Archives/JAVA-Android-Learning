...
public class UserAboutSitesView extends LinearLayout
{
    ...
    private void init()
    {
        ButterKnife.a(this, LayoutInflater.from(getContext()).inflate(0x7f030146, this, true));
    ...
    private void updateFreeFormSite(String s, String s1, LinearLayout linearlayout, PTextView ptextview, LinearLayout linearlayout1, PTextView ptextview1)
    {
        ...
        if (ModelHelper.isValid(s))
        {
            ...
            if (flag)
            {
                ViewHelper.showIconForLongText((TextView)linearlayout1.findViewById(0x7f0b029a), 0x7f020108);
    ...
    private void updateImpressum()
    {
        ...
        } else
        {
            ...
            updateFreeFormSite(_user.getImpressumUrl(), Resources.string(0x7f0e0291), _impressumVw, _impressumTv, _impressumBtContainer, _addImpressumTv);
            return;
        }
    }
    ...
    {
        UserEditWebsiteDialog usereditwebsitedialog = new UserEditWebsiteDialog();
        usereditwebsitedialog.addUserUidToArguments(_user.getUid());
        usereditwebsitedialog.setResponseHandler(_aboutUpdateListener);
        Events.post(new DialogEvent(usereditwebsitedialog));
    }
    ...
    void onSiteClicked(View view)
    {
        ...
        view.getId();
        JVM INSTR tableswitch 2131428060 2131428061: default 44
    //                   2131428060 67
    //                   2131428061 74;
           goto _L1 _L2 _L3
_L1:
    ...
    private class _cls1 extends ApiResponseHandler
    {
        ...
        public void onSuccess(final ApiResponse innerUrl)
        {
            ...
            if (s.equalsIgnoreCase("blocked"))
            {
                ...
                innerUrl.setTitle(0x7f0e0493);
                innerUrl.setMessage(((String) (obj)));
                innerUrl.setPositiveButton(0x7f0e033a, null);
