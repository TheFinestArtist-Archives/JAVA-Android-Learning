...
import com.pinterest.activity.pin.gridcells.old.comments.PinCommentsStandaloneCell;
...
public class PinCommentsFragment extends BaseFragment
{
    ...
    {
        PinApi.f(_navigation.getId(), new _cls2(), getApiTag());
    }
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _actionBar.setTitle(0x7f0e00ee);
