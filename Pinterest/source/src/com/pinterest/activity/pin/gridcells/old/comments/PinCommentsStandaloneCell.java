...
import com.pinterest.activity.pin.gridcells.old.PinViewBaseCell;
...
//            PinCommentView, PinCommentEditView
...
public class PinCommentsStandaloneCell extends PinViewBaseCell
{
    ...
    private void displayComments()
    {
        ...
        if (_comments != null)
        {
            ...
            {
                PinCommentEditView pincommenteditview = (PinCommentEditView)inflate(getContext(), 0x7f0300f0, null);
        ...
        if (i >= 0 && i < _comments.getCount())
        {
            ...
            if (comment != null)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        dialog.setMessage(Resources.string(0x7f0e0185, new Object[] {
                            s, user.getFirstName()
                        }));
                    }
