...
_L7:
        finalHtml = PinCloseUpImageView.access$000(PinCloseUpImageView.this).getImageMediumUrl();
        class _cls1
            implements Runnable
        {

            final PinCloseUpImageView._cls1 this$1;
            ...
            _cls1()
            {
                this$1 = PinCloseUpImageView._cls1.this;
                finalHtml = s;
                super();
            }
        }
...
_L6:
    ...
    _cls1()
    {
        this$0 = final_pincloseupimageview;
        val$url = String.this;
        super();
    }
}
