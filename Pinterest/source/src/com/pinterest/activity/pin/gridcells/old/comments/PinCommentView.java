...
public class PinCommentView extends FrameLayout
{
    ...
    protected void init()
    {
        ...
        LayoutInflater.from(getContext()).inflate(0x7f0300ef, this, true);
        _iconIv = (WebImageView)findViewById(0x7f0b01d8);
        _iconIv.setOval(true);
        _nameTv = (TextView)findViewById(0x7f0b012c);
        _dateTv = (TextView)findViewById(0x7f0b0225);
        _commentTv = (TextView)findViewById(0x7f0b0224);
    ...
    public void setCommentDate(Date date)
    {
        if (_comment != null && _pin != null && _pin.getUserUid() != null)
        {
            ...
            if (_comment.getUserUid().equals(_pin.getUserUid()))
            {
                ...
                {
                    date = com.pinterest.kit.application.Resources.string(0x7f0e0379);
                } else
                {
                    date = com.pinterest.kit.application.Resources.string(0x7f0e037a, new Object[] {
                        s
                    });
                }
            }
