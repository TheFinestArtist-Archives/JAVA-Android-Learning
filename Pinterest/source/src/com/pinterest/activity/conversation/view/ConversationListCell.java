...
public class ConversationListCell extends RelativeLayout
{
    ...
    private void adjustCellLayout(ConversationMessage conversationmessage)
    {
        ...
        int i = (int)Resources.dimension(0x7f0a0068);
        int j = (int)Resources.dimension(0x7f0a0067);
        ...
        if (MyUser.isUserMe(conversationmessage.getSenderId()))
        {
            ...
            alignParentRight(_pinView);
            alignParentRight(_boardView);
            alignParentRight(_userMsgEt);
            if (flag)
            {
                _userMsgEt.setBackgroundResource(0x7f02006b);
        ...
        } else
        {
            ...
            alignRightOf(_userAvatar, _pinView);
            alignRightOf(_userAvatar, _boardView);
            if (flag)
            {
                _userMsgEt.setBackgroundResource(0x7f02006a);
                _userMsgEt.setTextColor(Resources.color(0x7f09006b));
        ...
        if (flag)
        {
            ...
            i = (int)Resources.dimension(0x7f0a0093);
        } else
        {
            i = 0;
        }
    ...
    protected void onFinishInflate()
    {
        ...
        _loadingSpinner = (SmallLoadingView)findViewById(0x7f0b01e4);
        _dateView = (BevelTitleDivider)findViewById(0x7f0b01f2);
        _userMsgEt = (TextView)findViewById(0x7f0b01f3);
        _userAvatar = (RoundProfileImageCell)findViewById(0x7f0b01f4);
        _pinViewStub = (ViewStub)findViewById(0x7f0b01f5);
        _boardViewStub = (ViewStub)findViewById(0x7f0b01f7);
    }
        ...
        implements android.view.View.OnLongClickListener
    {
        ...
        public boolean onLongClick(View view)
        {
            ...
            Application.showToast(0x7f0e04a8);
            return true;
        }
