...
public class RecentConversationCell extends BaseNotificationListCell
{
    ...
    public static RecentConversationCell from(View view, Context context)
    {
        ...
        {
            return (RecentConversationCell)ViewHelper.viewById(context, 0x7f0300f3);
        }
    }
...
_L3:
        _subTitleTv.setText(0x7f0e034a);
_L6:
        return;
_L4:
        if (cellposition.size() > 2)
        {
            _subTitleTv.setText(0x7f0e037d);
            return;
        } else
        {
            _subTitleTv.setText(0x7f0e037b);
            return;
        }
_L2:
        if (conversation != null && conversation.size() > 0)
        {
            _subTitleTv.setText(0x7f0e037c);
            return;
        }
