    ...
    implements android.widget.tener
{
    ...
    public void onScroll(AbsListView abslistview, int i, int j, int k)
    {
        if (i == 0 && k > 0 && ConversationFragment.access$000(ConversationFragment.this).getNextUrl() != null && !ConversationFragment.access$100(ConversationFragment.this))
        {
            ...
            ConversationApi.h(ConversationFragment.access$000(ConversationFragment.this).getNextUrl(), ConversationFragment.access$200(ConversationFragment.this), ConversationFragment.access$300(ConversationFragment.this));
