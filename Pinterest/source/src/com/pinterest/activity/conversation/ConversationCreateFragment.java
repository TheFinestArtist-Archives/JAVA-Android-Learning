...
public class ConversationCreateFragment extends BaseFragment
{
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _actionBar.setTitle(0x7f0e0300);
        bundle = (PButton)LayoutInflater.from(view.getContext()).inflate(0x7f03011c, _actionBar, false);
        bundle.setText(0x7f0e0309);
