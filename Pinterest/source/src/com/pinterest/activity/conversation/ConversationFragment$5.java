...
class this._cls0 extends ApiResponseHandler
{
    ...
    public void onFailure(Throwable throwable, ApiResponse apiresponse)
    {
        ...
        ConversationFragment.access$600(ConversationFragment.this).post(new _cls2());
    }

    public void onSuccess(final PinterestJsonObject moreItems)
    {
        moreItems = new ConversationMessagesFeed(ConversationFragment.access$700(ConversationFragment.this), moreItems, getBaseUrl());
        class _cls1
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                ConversationFragment.access$102(this$0, false);
                int i = ConversationFragment.access$600(this$0).getFirstVisiblePosition();
                int j = moreItems.getCount();
                ConversationFragment.access$600(this$0).setSelection(i + j);
            }
