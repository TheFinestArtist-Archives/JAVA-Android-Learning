...
label0:
        {
            ...
            if (i > 0)
            {
                ...
                if (conversationmessage.getCreatedAt().getTime() - conversationmessage1.getCreatedAt().getTime() <= 0x5265c00L)
                {
                    break label0;
                }
                flag = true;
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            view = (ConversationListCell)_li.inflate(0x7f0300d5, viewgroup, false);
        } else
        {
