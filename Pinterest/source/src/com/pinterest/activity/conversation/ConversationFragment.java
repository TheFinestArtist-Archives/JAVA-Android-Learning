...
_L1:
        ...
        navigation.putExtra("com.pinterest.EXTRA_SEARCH_MODE", "VALUE_SEARCH_GLOBAL");
        navigation.putExtra("com.pinterest.EXTRA_CONVERSATION_ID", _conversationId);
        _addPinFragment.setNavigation(navigation);
        FragmentHelper.replaceFragment(this, 0x7f0b0149, _addPinFragment, false, com.pinterest.activity.FragmentHelper.Animation.MODAL);
_L4:
...
_L3:
    ...
    protected void onDeactivate()
    {
        if (getActivity() != null)
        {
            ...
            FragmentHelper.replaceFragment(this, 0x7f0b0149, null, false);
        }
        super.onDeactivate();
    }
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        getActivity().getWindow().setSoftInputMode(16);
        _replyEt = (PEditText)view.findViewById(0x7f0b0147);
        updateConversationMetadata();
        _listView = (ListView)view.findViewById(0x7f0b0095);
        bundle = new View(view.getContext());
        bundle.setMinimumHeight((int)Resources.dimension(0x7f0a0093));
        ...
        _sendBtn = (PButton)view.findViewById(0x7f0b0145);
        _sendBtn.setOnClickListener(onSendMessage);
        _addPin = view.findViewById(0x7f0b0146);
        _addPin.setOnClickListener(onAddPin);
        _replyEt.setText("");
        initConversation();
        if (_conversation != null && _conversation.getCachedUsers().size() == 1)
        {
            _actionBar.getMenu().findItem(0x7f0b0306).setVisible(false);
            _actionBar.getMenu().findItem(0x7f0b0305).setVisible(false);
        }
...
/*
    static TextView access$1702(ConversationFragment conversationfragment, TextView textview)
    {
...
/*
    static String access$1902(ConversationFragment conversationfragment, String s)
    {
...
/*
    static Conversation access$402(ConversationFragment conversationfragment, Conversation conversation)
    {
...
*/
    ...
    private class _cls4 extends com.pinterest.base.Events.EventsSubscriber
    {
        ...
        {
            overridenavigationevent = overridenavigationevent.a();
...
_L1:
            pinterestjsonobject = (PinterestJsonObject)pinterestjsonobject.a().get(_conversationId);
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            if (_nonPinnerListFooter == null)
            {
                ...
                _nonPinnerListFooter.setText(0x7f0e020e);
                _nonPinnerListFooter.setTextColor(Resources.color(0x7f09006c));
