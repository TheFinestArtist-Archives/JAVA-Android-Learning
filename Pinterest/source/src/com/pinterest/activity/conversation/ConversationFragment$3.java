...
class eResponseHandler extends com.pinterest.api.remote.ationMessageResponseHandler
{
    ...
    public void onSuccess(ConversationMessagesFeed conversationmessagesfeed)
    {
        ...
        int i = ConversationFragment.access$600(ConversationFragment.this).getLastVisiblePosition();
        ...
        if (i == j - 1)
        {
            ConversationFragment.access$600(ConversationFragment.this).setSelection(ConversationFragment.access$000(ConversationFragment.this).getCount() - 1);
        }
    }
