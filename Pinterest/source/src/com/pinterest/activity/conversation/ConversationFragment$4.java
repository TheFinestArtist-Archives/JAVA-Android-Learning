...
class this._cls0 extends com.pinterest.base.
{
    ...
    {
        if (_pcls4.getConversation().getUid().equals(ConversationFragment.access$700(ConversationFragment.this)))
        {
    ...
    public void onEventMainThread(com.pinterest.api.model.t t)
    {
        class _cls1 extends BackgroundTask
        {
            ...
            public void run()
            {
                ...
                _feed = new ConversationMessagesFeed(ModelHelper.getConversationMessages(ConversationFragment.access$700(this$0), i));
            }
        ...
        if (t.getConversation().getUid().equals(ConversationFragment.access$700(ConversationFragment.this)))
        {
            (new _cls1()).execute();
        }
    }
    ...
    {
        if (event.getConversationId().equals(ConversationFragment.access$700(ConversationFragment.this)))
        {
            ConversationFragment.access$000(ConversationFragment.this).addMessage(event.getConversationMessage());
            ConversationFragment.access$1000(ConversationFragment.this);
        }
    }
    ...
    public void onEventMainThread(OverrideNavigationEvent overridenavigationevent)
    {
        ...
        ConversationApi.a(ConversationFragment.access$700(ConversationFragment.this), overridenavigationevent, null, ConversationFragment.access$1100(ConversationFragment.this), ConversationFragment.access$1200(ConversationFragment.this));
        if (ConversationFragment.access$1300(ConversationFragment.this) != null)
        {
            hidePinFragment();
        }
    }
