...
public class iew
{
    ...
    {
        nuxactivity._wrapper = (FrameLayout)._wrapper(obj, 0x7f0b006a, "field '_wrapper'");
        nuxactivity._progressBar = (NUXProgressIndicatorView).gressIndicatorView(obj, 0x7f0b0071, "field '_progressBar'");
    }
