    ...
    implements ExperienceEnabled
{
    ...
    public void onNextButtonClicked()
    {
        ...
        {
            NUXSocialSkipDialog nuxsocialskipdialog = new NUXSocialSkipDialog(_viewAdapter.getCurrentFragmentCount());
            nuxsocialskipdialog.setNegativeButton(0x7f0e048d, new _cls5());
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _header.setTitle(getResources().getString(0x7f0e032f));
        _header.setSkipTitle(com.pinterest.kit.application.Resources.string(0x7f0e0320));
        _header.setTitleDesc(getResources().getString(0x7f0e032e));
        _header.setSkipDesc(com.pinterest.kit.application.Resources.string(0x7f0e0324));
        _header.setSkipPosTx(com.pinterest.kit.application.Resources.string(0x7f0e0323));
        _header.setSkipNegTx(com.pinterest.kit.application.Resources.string(0x7f0e048d));
        ...
        _continueBar.updateText(0x7f0e031c);
        _continueBar.setContinueText(com.pinterest.kit.application.Resources.string(0x7f0e0325));
        view = getActivity();
        if (view != null)
        {
            view = view.getSupportFragmentManager().beginTransaction();
        } else
        {
            view = null;
        }
        if (view != null)
        {
            view.add(0x7f0b017f, _viewAdapter.getItem(0), null);
            view.add(0x7f0b017f, _viewAdapter.getItem(1), null);
            view.add(0x7f0b017f, _viewAdapter.getItem(2), null);
...
_L1:
            return;
_L2:
            if (_viewAdapter.getCurrentFragmentCount() != 0)
            {
...
_L3:
            if (_viewAdapter.getCurrentFragmentCount() != 1)
            {
