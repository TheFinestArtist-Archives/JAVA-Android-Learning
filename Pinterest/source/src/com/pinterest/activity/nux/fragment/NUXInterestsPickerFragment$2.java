    ...
    implements NUXNextFragmentListener
{
    ...
    {
        ((NUXActivity)getActivity()).submitInterests(((NUXInterestGridAdapter)NUXInterestsPickerFragment.access$1100(NUXInterestsPickerFragment.this)).getCheckedInterests());
        goToNextFragment();
    }

    public void skipFragment()
    {
        ((NUXInterestGridAdapter)NUXInterestsPickerFragment.access$1200(NUXInterestsPickerFragment.this)).clearInterests();
