    ...
    implements ExperienceEnabled
{
    ...
    {
        initIndicators();
        setLayoutParams(new android.widget.LinearLayout.LayoutParams(-1, 0x7f0a00ab));
        setBackgroundColor(getResources().getColor(0x7f090047));
        setVisibility(4);
    }
    ...
    private void initIndicators()
    {
        ...
        while (j < MAX_STEPS) 
        {
            ...
            nuxprogresscell.setLayoutParams(new android.view.ViewGroup.LayoutParams(k + 1, (int)com.pinterest.kit.application.Resources.dimension(0x7f0a00ab)));
            ...
            if (isFirstInterest)
            {
                if (j < INTERESTS_STEP)
                {
                    nuxprogresscell.setBackgroundColor(com.pinterest.kit.application.Resources.color(0x7f09000a));
                } else
                {
                    nuxprogresscell.setBackgroundColor(com.pinterest.kit.application.Resources.color(0x7f090043));
                    i = 0x7f02018e;
                }
            } else
            if (j >= SOCIAL_STEP)
...
_L1:
        ...
        {
            k = com.pinterest.kit.application.Resources.color(0x7f090025);
        } else
        if (i1 == TWITTER_STEP && _isTwitterComplete)
        {
            k = com.pinterest.kit.application.Resources.color(0x7f090071);
        } else
        if (isFirstInterest)
        {
            if (i1 <= INTERESTS_STEP && i1 <= _interestStep)
            {
                k = com.pinterest.kit.application.Resources.color(0x7f09003a);
            } else
            {
                ...
                k = com.pinterest.kit.application.Resources.color(0x7f090043);
            }
        } else
