...
public class NUXAnimatedPinView extends FrameLayout
{
    ...
    private void init()
    {
        ...
        options.inTargetDensity = Device.getDensityDpi();
        _illustrationWidth = (int)((float)BitmapFactory.decodeResource(getResources(), 0x7f020163, options).getWidth() + Resources.dimension(0x7f0a009b) * 2.0F);
        _adapter.addItem(getResources().getDrawable(0x7f020169));
        _adapter.addItem(getResources().getDrawable(0x7f020164));
        _adapter.addItem(getResources().getDrawable(0x7f020163));
        _adapter.addItem(getResources().getDrawable(0x7f02016b));
        _adapter.addItem(getResources().getDrawable(0x7f020165));
        _adapter.addItem(getResources().getDrawable(0x7f020166));
    }
    ...
    protected void onFinishInflate()
    {
        ...
        for (int i = 0; i < _numImages; i++)
        {
            ...
            layoutparams.setMargins(0x7f0a009b, 0, 0x7f0a009b, 0);
