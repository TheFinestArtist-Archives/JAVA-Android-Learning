...
public class NUXContinueBar extends RelativeLayout
{
    ...
    private void init()
    {
        LayoutInflater.from(getContext()).inflate(0x7f030134, this);
        ButterKnife.a(this);
        ...
        setBackgroundColor(Resources.color(0x7f09000b));
    }
    ...
    public void popInAnimate()
    {
        if (getVisibility() == 4)
        {
            ...
            AnimatorSet animatorset = new AnimatorSet();
            animatorset.playTogether(new Animator[] {
                AnimationUtils.springAnimate(this, "translationY", getHeight(), Resources.dimension(0x7f0a00a5), 1.25F, 1.0F)
            });
