...
public class NUXSocialTabBar extends TabBar
{
    ...
    private void popInSocialIcons()
    {
        ...
        if (_selectedIndex == 2)
        {
            tab.setIcon(0x7f02018c);
            tab.setBackgroundResource(0x7f0201bc);
            tab.getImageView().setAlpha(0.0F);
            animateTabButtonImage(tab.getImageView(), 1000);
            tab1.setIcon(0x7f020191);
            tab1.setBackgroundResource(0x7f0201bc);
...
label0:
        {
            ...
            {
                tab.setBackgroundResource(0x7f0201bd);
                if (_selectedIndex == 0)
                {
                    tab.setIcon(0x7f02018a, 2);
                    tab.setIcon(0x7f02018a);
                    animateTabButtonFade(tab);
                } else
                {
                    tab.setIcon(0x7f02018b, 2);
                    tab.setIcon(0x7f02018b);
                }
            }
            if (_isTwitterConnected)
            {
                tab1.setBackgroundResource(0x7f0201be);
                if (_selectedIndex != 1)
                {
                    break label0;
                }
                animateTabButtonFade(tab1);
                tab1.setIcon(0x7f02018f, 2);
                tab1.setIcon(0x7f02018f);
            }
            return;
        }
        tab1.setIcon(0x7f020190, 2);
        tab1.setIcon(0x7f020190);
    }
