...
public class EmailFrequencyDialog extends BaseDialog
{
    ...
    public void make(LayoutInflater layoutinflater)
    {
        ...
        {
            _container = LayoutInflater.from(getActivity()).inflate(0x7f03004a, null);
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        setPositiveButton(getString(0x7f0e040b), onSaveClick);
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(final View choiceString)
        {
            ...
            if (i != 0x7f0b00cc || !_initialSetting.equals("daily")) goto _L2; else goto _L1
_L1:
...
_L4:
            ...
            return;
_L2:
            if (i == 0x7f0b00cd && _initialSetting.equals("immediate"))
            {
