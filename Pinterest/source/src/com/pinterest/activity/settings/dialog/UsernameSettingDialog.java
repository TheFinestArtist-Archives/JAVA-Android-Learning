...
public class UsernameSettingDialog extends BaseDialog
{
    ...
    public void make(LayoutInflater layoutinflater)
    {
        ...
        {
            _container = LayoutInflater.from(getActivity()).inflate(0x7f030068, null);
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        if (_username != null)
        {
            if ((name = MyUser.get()) != null)
            {
                ...
                _username.setImeActionLabel(Resources.string(0x7f0e040b), 2);
                _username.setOnEditorActionListener(new _cls1());
                setPositiveButton(getString(0x7f0e040b), new _cls2());
                setNegativeButton(getString(0x7f0e008f), new _cls3());
    ...
    private class _cls4 extends com.pinterest.api.remote.MyUserApi.SettingsApiResponse
    {
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            Application.showToastShort(String.format(Resources.string(0x7f0e0305), new Object[] {
                newnameF
            }));
            Events.post(new DialogEvent(null));
        }
