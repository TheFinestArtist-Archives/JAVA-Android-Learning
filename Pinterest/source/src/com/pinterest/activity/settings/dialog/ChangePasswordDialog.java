...
public class ChangePasswordDialog extends BaseDialog
{
    ...
    private void onSavePwdClicked()
    {
        ...
        {
            Application.showToast(0x7f0e03ae);
            return;
        }
        if (TextUtils.isEmpty(s1))
        {
            Application.showToast(0x7f0e03ad);
            return;
        }
    ...
    private void showChangePwdFailedDialog(ApiResponse apiresponse)
    {
        ...
        dialog.setTitle(0x7f0e0505);
        dialog.setMessage(apiresponse.getMessageDetailIfExist());
        dialog.setPositiveButton(0x7f0e04b7, new _cls5());
        dialog.setNegativeButton(0x7f0e0268, new _cls6());
    ...
    public void make(LayoutInflater layoutinflater)
    {
        ...
        {
            _container = LayoutInflater.from(getActivity()).inflate(0x7f03003f, null);
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            if (MyUser.get() != null)
            {
                ...
                if (view != null)
                {
                    AccountApi.b(view, new com.pinterest.api.remote.AccountApi.ResetPasswordApiResponse());
                }
            }
        }
