...
public class CountrySettingDialog extends BaseDialog
{
    ...
    private void initAdapter(PinterestJsonObject pinterestjsonobject)
    {
        ...
        for (pinterestjsonobject = pinterestjsonobject.a.entrySet().iterator(); pinterestjsonobject.hasNext(); ((HashMap) (obj)).put(entry.getKey(), ((JsonElement)entry.getValue()).getAsString()))
        {
            entry = (java.util.Map.Entry)pinterestjsonobject.next();
        }

        for (pinterestjsonobject = ((Map) (obj)).entrySet().iterator(); pinterestjsonobject.hasNext(); _countries.add(new Country((String)((java.util.Map.Entry) (obj)).getKey(), (String)((java.util.Map.Entry) (obj)).getValue())))
        {
            obj = (java.util.Map.Entry)pinterestjsonobject.next();
        }
    ...
    public void make(LayoutInflater layoutinflater)
    {
        ...
        {
            _container = LayoutInflater.from(getActivity()).inflate(0x7f03003e, null);
    ...
    {
        setTitle((new StringBuilder()).append(Resources.string(0x7f0e0133)).append(": ").append(LocaleUtils.getCountry()).toString());
        ...
        public void onItemClick(final AdapterView country, View view, int i, long l)
        {
            ...
            class _cls1 extends ApiResponseHandler
            {
                ...
                public void onSuccess(ApiResponse apiresponse)
                {
                    ...
                    Events.post(new DialogEvent(null));
                    Events.post(new com.pinterest.activity.settings.AccountSettingsFragment.AccountSettingsEvent());
                }
