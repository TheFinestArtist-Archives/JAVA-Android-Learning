...
_L1:
        Application.showToastShort(0x7f0e0465);
_L4:
        return;
_L2:
...
_L3:
    ...
    public void make(LayoutInflater layoutinflater)
    {
        ...
        {
            _container = LayoutInflater.from(getActivity()).inflate(0x7f030049, null);
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        } else
        {
            ...
            _emailEt.setImeActionLabel(Resources.string(0x7f0e040b), 2);
    ...
    private class _cls3 extends com.pinterest.api.remote.MyUserApi.SettingsApiResponse
    {
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            Application.showToastShort(String.format(Resources.string(0x7f0e02ff), new Object[] {
                newemailF
            }));
