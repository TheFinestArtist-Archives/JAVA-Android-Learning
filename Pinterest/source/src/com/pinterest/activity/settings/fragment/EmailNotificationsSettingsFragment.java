    ...
    implements Scrollable
{
    ...
    private void setFrequency(PinterestJsonObject pinterestjsonobject)
    {
        ...
        {
            pinterestjsonobject = Resources.string(0x7f0e033d);
        } else
        {
            pinterestjsonobject = Resources.string(0x7f0e0503);
        }
        if (frequencyTv != null)
        {
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _actionBar.setTitle(0x7f0e01cd);
        initUi(view);
    }
    ...
    static 
    {
        ...
        VIEW_KEYS = hashtable;
        hashtable.put(Integer.valueOf(0x7f0b010a), "email_enabled");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b010e), "email_repins");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b010f), "email_likes");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b0110), "email_follows");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b0116), "email_comments");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b0117), "email_shares");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b0118), "email_friends_joining");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b0119), "email_collaboration_invite");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b011c), "email_product_changes");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b011d), "email_suggestions");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b011e), "email_news");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b011f), "email_updates");
        VIEW_KEYS.put(Integer.valueOf(0x7f0b0120), "email_feedback_and_research");
    }
    ...
    private class _cls2 extends BaseDialog
    {
        ...
        public void onActivityCreated(Bundle bundle)
        {
            ...
            setPositiveButton(0x7f0e01ce, new _cls1());
            class _cls2
                implements android.view.View.OnClickListener
            {
            ...
            setNegativeButton(0x7f0e008f, new _cls2());
        }
