    ...
    implements android.view.cationsSettingsFragment._cls2._cls1
{
    ...
    public void onClick(View view)
    {
        ...
        SettingsApi.e((String)EmailNotificationsSettingsFragment.access$200().get(Integer.valueOf(ctv.getId())), String.valueOf(ctv.isChecked()), new _cls1(false), EmailNotificationsSettingsFragment.access$300(_fld0));
        smiss();
    }
