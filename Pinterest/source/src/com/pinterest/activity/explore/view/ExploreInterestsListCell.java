...
public class ExploreInterestsListCell extends LinearLayout
{
    ...
    protected void init()
    {
        LayoutInflater.from(getContext()).inflate(0x7f0300e4, this, true);
        ButterKnife.a(this);
        ...
        _interestListView.setSelector(0x7f0201b9);
        _title.setOnClickListener(new _cls2());
        setOrientation(1);
        setPadding(0, (int)Resources.dimension(0x7f0a0098), 0, 0);
    }
    ...
    protected void navigateToCategoryOrInterest(Interest interest)
    {
        ...
        if ("2".equals(interest.getUid()))
        {
            ...
            category.setName(Resources.string(0x7f0e020c));
        ...
        if ("3".equals(interest.getUid()))
        {
            ...
            category1.setName(Resources.string(0x7f0e03b0));
            ModelHelper.setInterest(interest);
            MyUser.addLastUsedInterest(interest.getUid());
    ...
    public void updateUI()
    {
        if (_interest != null)
        {
            ...
            {
                _interestListView.setSelectionFromOffset(_scrollPosition, (int)Resources.dimension(0x7f0a0098));
            }
        }
    }
