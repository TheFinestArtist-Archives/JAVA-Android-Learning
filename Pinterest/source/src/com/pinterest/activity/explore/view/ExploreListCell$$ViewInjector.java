...
public class 
{
    ...
    {
        explorelistcell._wrapper = elistcell._wrapper(obj, 0x7f0b01d7, "field '_wrapper'");
        explorelistcell._icon = (WebImageView)elistcell._icon(obj, 0x7f0b01d8, "field '_icon'");
        explorelistcell._title = (TextView)elistcell._title(obj, 0x7f0b0065, "field '_title'");
        explorelistcell._titleOnlyTv = (TextView)elistcell._titleOnlyTv(obj, 0x7f0b01d6, "field '_titleOnlyTv'");
    }
