...
public class ExploreInterestsAdapter extends BaseAdapter
{
    ...
    private void updateInterestsToPrepend()
    {
        ...
        if (CollectionUtils.isNotEmpty(_recentInterests))
        {
            ...
            interest.setName(Resources.string(0x7f0e03d3));
        ...
        if (CollectionUtils.isNotEmpty(_trendingInterests))
        {
            ...
            interest1.setUid("3");
            interest1.setName(Resources.string(0x7f0e04b6));
    ...
    public void setTrendingInterests(ArrayList arraylist)
    {
        ...
        Interest interest = new Interest();
        interest.setName(Resources.string(0x7f0e02ed));
        interest.setUid("3");
        ...
        if (!Experiments.f())
        {
            ...
            arraylist.setName(Resources.string(0x7f0e020c));
            arraylist.setUid("2");
