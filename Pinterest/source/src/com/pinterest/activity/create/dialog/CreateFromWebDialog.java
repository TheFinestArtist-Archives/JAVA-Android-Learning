...
public class CreateFromWebDialog extends BaseDialog
{
    ...
    private void tryGoUrl()
    {
        ...
        {
            Application.showToast(0x7f0e02f4, 0, 0);
            return;
        }
    }
    ...
    {
        _container = LayoutInflater.from(getActivity()).inflate(0x7f030052, null);
    ...
    public void onActivityCreated(Bundle bundle)
    {
        ...
        setPositiveButton(0x7f0e0223, new _cls2());
        setNegativeButton(0x7f0e0348, new _cls3());
    }
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                Application.showToast(0x7f0e02f3, 0, 0);
                return;
            }
        }
