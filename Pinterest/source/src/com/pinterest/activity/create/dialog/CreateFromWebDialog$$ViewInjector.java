...
public class 
{
    ...
    {
        createfromwebdialog._editText = (EditText)mwebdialog._editText(obj, 0x7f0b00dc, "field '_editText'");
        createfromwebdialog._textView = (TextView)mwebdialog._textView(obj, 0x7f0b00db, "field '_textView'");
    }
