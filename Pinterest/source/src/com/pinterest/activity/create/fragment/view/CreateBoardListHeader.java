...
public class CreateBoardListHeader extends RelativeLayout
{
    ...
    private void init()
    {
        ...
        _titleCell = (DialogTitleView)findViewById(0x7f0b0206);
        _titleCell.titleTv.setText(0x7f0e0154);
        _titleCell.setHeight((int)getResources().getDimension(0x7f0a0025));
        _titleCell.titleDivider.setVisibility(8);
        _titleCell.setVisibility(0);
        _facebookCb = (CheckBox)findViewById(0x7f0b0207);
