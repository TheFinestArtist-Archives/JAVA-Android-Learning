...
public class BoardPickerFragment extends ListFragment
{
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        _headerVw = (DialogTitleView)view.findViewById(0x7f0b00dd);
        if (_headerVw != null)
        {
            _headerVw.titleTv.setText(0x7f0e0154);
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            if (_pin != null)
            {
                ...
                Events.post(new Navigation(Location.BOARD, _pin.getPinnedToBoardUid()));
            }
        }
    ...
    private class _cls7 extends ApiResponseHandler
    {
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            com.pinterest.api.PinterestJsonObject pinterestjsonobject = DiskCache.getJsonObject("MY_PICKER_BOARDS");
            if (_adapter != null)
            {
