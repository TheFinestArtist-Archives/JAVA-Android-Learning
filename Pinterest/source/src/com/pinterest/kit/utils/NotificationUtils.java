...
public class NotificationUtils
{
    ...
    private static Bitmap getInspiredImageText()
    {
        ...
        obj.inMutable = true;
        obj = Resources.bitmap(0x7f020172, ((android.graphics.BitmapFactory.Options) (obj)));
        (new Canvas(((Bitmap) (obj)))).drawText(Resources.string(0x7f0e0293), ((Bitmap) (obj)).getWidth() / 2, ((Bitmap) (obj)).getHeight() / 2, whitePaint);
        return ((Bitmap) (obj));
    }
    ...
    private static void initPaint()
    {
        ...
        } else
        {
            ...
            whitePaint.setTextSize((int)Resources.dimension(0x7f0a00f4));
    ...
    public static void showSignupNotification()
    {
        ...
        } else
        {
            ...
            String s = Resources.string(0x7f0e046e);
            obj = Resources.string(0x7f0e01a1);
            obj1 = (new android.support.v4.app.NotificationCompat.Builder(((android.content.Context) (obj1)))).setContentTitle(s).setContentText(((CharSequence) (obj))).setSmallIcon(0x7f02014b).setAutoCancel(true).setOnlyAlertOnce(true).setContentIntent(((PendingIntent) (obj2)));
