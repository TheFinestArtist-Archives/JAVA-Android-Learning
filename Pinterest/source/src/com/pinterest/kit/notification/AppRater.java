...
public class AppRater
{
    ...
    private static final String APP_NAME = Resources.string(0x7f0e0045);
    private static final String APP_PACKAGE = Application.context().getPackageName();
    private static final String DIALOG_LATER_BT = Resources.string(0x7f0e02b0);
    private static final String DIALOG_MESSAGE = Resources.string(0x7f0e03c9, new Object[] {
        APP_NAME
    });
    private static final String DIALOG_NO_BT = Resources.string(0x7f0e030a);
    private static final String DIALOG_RATE_BT = Resources.string(0x7f0e03c8);
    private static final String DIALOG_TITLE = Resources.string(0x7f0e03cb, new Object[] {
        APP_NAME
    });
