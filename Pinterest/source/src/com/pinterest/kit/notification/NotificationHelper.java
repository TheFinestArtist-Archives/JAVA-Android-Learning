...
public class NotificationHelper
{
    ...
    {
        Notification notification = new Notification(0x7f02014b, s1, l);
        PApplication papplication = PApplication.context();
        notification.setLatestEventInfo(papplication, s, s1, PendingIntent.getActivity(papplication, 0, intent, 0x8000000));
