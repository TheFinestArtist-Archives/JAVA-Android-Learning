    ...
    implements AutoUpdateClient
{
    ...
    static void c()
    {
        ...
        basedialog.setTitle(0x7f0e0304);
        basedialog.setMessage(Resources.string(0x7f0e0516, new Object[] {
            Integer.valueOf(a - e())
        }));
        basedialog.setPositiveButton(0x7f0e04d2, new _cls3(basedialog));
        basedialog.setNegativeButton(0x7f0e0315, null);
    ...
    static void d()
    {
        Notification notification = NotificationHelper.getNotification(Resources.string(0x7f0e0045), Resources.string(0x7f0e01a4));
    ...
    public void checkForUpdate()
    {
        ...
        {
            ApiHttpClient.get("http://s3.amazonaws.com/pinterest-ota-builds/status_android.json", c, false, true, false, null, null);
            return;
        }
    }
    ...
    {
        Application.showToast(0x7f0e04d5);
        activity = String.format("http://s3.amazonaws.com/pinterest-ota-builds/android/Android/%d/pinterest-master.apk", new Object[] {
            Integer.valueOf(a)
        });
        d.a(activity);
