...
public class SocialConnectActivity extends DialogHostActivity
{
    ...
    private void connectToFacebook(com.pinterest.base.Social.RequestConnectEvent requestconnectevent)
    {
        if (Device.GTE_LP)
        {
            ...
            {
                Application.showToast(0x7f0e0212);
                return;
            }
        }
    ...
    private void doGPlusRegistration()
    {
        ...
        _signupParams.i = oneTimeCode;
        _signupParams.o = "";
        _signupParams.r = "unspecified";
        _signupParams.q = "";
        try
        {
    ...
    private String getGPlusIdTokenBlocking()
    {
        ...
        {
            userrecoverableauthexception.toString();
            return null;
        }
        catch (GoogleAuthException googleauthexception)
        {
            Log.getStackTraceString(googleauthexception);
            return null;
        }
        catch (Exception exception)
        {
        ...
        if (intent != null)
        {
            if ((intent = intent.getExtras()) != null)
            {
                if (i == -1)
                {
                    ...
                    _loginParams = new com.pinterest.api.remote.AccountApi.SocialConnectParams();
                    _loginParams.h = intent.getString("com.pinterest.EXTRA_ID");
                    _loginParams.d = intent.getString("com.pinterest.EXTRA_TOKEN");
                    _loginParams.f = intent.getString("com.pinterest.EXTRA_REFRESH_TOKEN");
                    if (MyUser.hasAccessTokenAndUser())
                    {
...
_L3:
        PLog.a("declined permissions: %s", new Object[] {
...
_L5:
        ...
        if (intent != null)
        {
            if ((bundle = intent.getExtras()) != null)
            {
                if (i == -1)
                {
                    ...
                    _loginParams = new com.pinterest.api.remote.AccountApi.SocialConnectParams();
                    _loginParams.g = bundle.getString("com.pinterest.EXTRA_ID");
                    _loginParams.d = bundle.getString("com.pinterest.EXTRA_TOKEN");
                    _loginParams.e = bundle.getString("com.pinterest.EXTRA_SECRET");
                    _loginParams.u = bundle.getString("com.pinterest.EXTRA_USER_NAME");
                    if (MyUser.hasAccessTokenAndUser())
                    {
                ...
                {
                    Events.post(new com.pinterest.base.Social.UpdateEvent(com.pinterest.base.Social.Network.TWITTER, null));
                    return;
                }
            }
        }
    ...
    {
        PLog.a("getGPlusOneTimeCode: ", new Object[0]);
        (new _cls13()).execute();
    }
    ...
    protected void onActivityResult(int i, int j, Intent intent)
    {
        ...
        PLog.a("onActivityResult: %d, %d ", new Object[] {
...
_L7:
    ...
    protected void onFacebookConnected(GraphUser graphuser, Session session)
    {
        ...
        _fbSession = session;
        _loginParams = new com.pinterest.api.remote.AccountApi.SocialConnectParams();
        _loginParams.k = graphuser.getId();
        _loginParams.v = graphuser.getLink();
        _loginParams.l = session.getAccessToken();
        _loginParams.m = StringUtils.join(session.getPermissions(), ",");
        PLog.a("facebookScope: %s", new Object[] {
            _loginParams.m
        });
        if (MyUser.hasAccessTokenAndUser())
        {
    ...
    protected void onFacebookSignup()
    {
        ...
        _signupParams.b = "";
        _signupParams.c = "";
        _signupParams.o = ((GraphUser) (obj)).getFirstName();
        _signupParams.p = ((GraphUser) (obj)).getLastName();
        _signupParams.k = ((GraphUser) (obj)).getId();
        _signupParams.v = ((GraphUser) (obj)).getLink();
        _signupParams.l = session.getAccessToken();
        _signupParams.m = StringUtils.join(session.getPermissions(), ",");
        _signupParams.q = (String)((GraphUser) (obj)).getProperty("email");
        obj = (String)((GraphUser) (obj)).getProperty("gender");
        if ("male".equals(obj))
        {
            _signupParams.r = "male";
        } else
        if ("female".equals(obj))
        {
            _signupParams.r = "female";
        } else
        {
            _signupParams.r = "unspecified";
        }
...
*/
        ...
        implements com.facebook.widget.FacebookDialog.Callback
    {
        ...
        public void onComplete(com.facebook.widget.FacebookDialog.PendingCall pendingcall, Bundle bundle)
        {
            ...
            PLog.a((new StringBuilder("FB share Success: ")).append(pendingcall).append(" ").append(_lastShare.id).toString(), new Object[0]);
            if ("post".equalsIgnoreCase(pendingcall))
            {
                flag = true;
                Application.showToast(0x7f0e0454);
            } else
        ...
        public void onError(com.facebook.widget.FacebookDialog.PendingCall pendingcall, Exception exception, Bundle bundle)
        {
            ...
            {
                Application.showToast(0x7f0e0453);
            }
        }
...
_L6:
    ...
    private class _cls10 extends ApiResponseHandler
    {
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            Pinalytics.a(EventType.USER_CREATE, null, Pinalytics.a());
            MyUserApi.a(onLoadMe, _apiTag);
        }
    ...
    private class _cls15 extends ApiResponseHandler
    {
        ...
        public void onSuccess(PinterestJsonObject pinterestjsonobject)
        {
            ...
            super.onSuccess(pinterestjsonobject);
            Application.showToastShort(0x7f0e0119);
        }
        ...
        implements com.google.android.gms.common.api.GoogleApiClient.ConnectionCallbacks, com.google.android.gms.common.api.GoogleApiClient.OnConnectionFailedListener
    {
        ...
        {
            PLog.a((new StringBuilder("onConnected: ")).append(bundle).toString(), new Object[0]);
        ...
        {
            PLog.a((new StringBuilder("onConnectionFailed: ")).append(connectionresult).toString(), new Object[0]);
    ...
    private class _cls13 extends BackgroundTask
    {
        ...
        public void onFinish()
        {
            ...
            } else
            {
                ...
                socialconnectparams.i = oneTimeCode;
