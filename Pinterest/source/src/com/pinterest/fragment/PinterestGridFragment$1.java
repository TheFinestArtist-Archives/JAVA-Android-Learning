...
class w.ScrollViewListener extends com.pinterest.ui.scrollview.ollViewListener
{
    ...
    {
        if (PinterestGridFragment.access$000(PinterestGridFragment.this) != null) goto _L2; else goto _L1
_L1:
        return;
_L2:
        int i1;
        k = PinterestGridFragment.access$100();
        i = k;
        if (Experiments.c())
        {
            i = k + PinterestGridFragment.access$200();
        }
        k = (int)PinterestGridFragment.access$300(PinterestGridFragment.this).getY();
...
_L3:
        PinterestGridFragment.access$400(PinterestGridFragment.this).setTranslationY(Math.min(0, i1));
        return;
        if (j <= l || k <= -i) goto _L1; else goto _L4
_L4:
        PinterestGridFragment.access$500(PinterestGridFragment.this).setTranslationY(Math.max(-i, i1));
        return;
    }
