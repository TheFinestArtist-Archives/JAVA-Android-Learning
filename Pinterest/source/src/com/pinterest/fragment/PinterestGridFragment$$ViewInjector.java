...
public class 
{
    ...
    {
        pinterestgridfragment._swipeVw = (SwipeRefreshLayout)ewinjector.ipeVw(obj, 0x7f0b013d);
        pinterestgridfragment._gridVw = (PinterestGridView)ewinjector.idVw(obj, 0x7f0b0127, "field '_gridVw'");
    }
