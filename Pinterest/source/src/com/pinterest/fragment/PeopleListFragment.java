...
public class PeopleListFragment extends ListFragment
{
    ...
    public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle)
    {
        ...
        _listView = (ListView)layoutinflater.findViewById(0x7f0b0095);
    ...
    public void onViewCreated(View view, Bundle bundle)
    {
        ...
        bundle = LayoutInflater.from(getActivity()).inflate(0x7f0300fe, null);
        _footerView = (AdapterFooterView)bundle.findViewById(0x7f0b0122);
