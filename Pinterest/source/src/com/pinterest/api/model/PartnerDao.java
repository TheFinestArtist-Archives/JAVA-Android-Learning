...
public class PartnerDao extends AbstractDao
{
    ...
    public static void createTable(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ...
        sqlitedatabase.execSQL((new StringBuilder("CREATE TABLE ")).append(s).append("'PARTNER' ('_id' INTEGER PRIMARY KEY AUTOINCREMENT ,'UID' TEXT,'ACCOUNT_TYPE' TEXT,'AUTO_FOLLOW_ALLOWED' INTEGER,'BUSINESS_NAME' TEXT,'CONTACT_NAME' TEXT,'TYPE' TEXT);").toString());
    }
    ...
    protected void bindValues(SQLiteStatement sqlitestatement, Partner partner)
    {
        ...
        if (partner != null)
        {
            sqlitestatement.bindString(7, partner);
        }
    }
    ...
    public Partner readEntity(Cursor cursor, int i)
    {
        ...
        return new Partner(long1, s, s1, boolean1, s2, s3, cursor);
    }
