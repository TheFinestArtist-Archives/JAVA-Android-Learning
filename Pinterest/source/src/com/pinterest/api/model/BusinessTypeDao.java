...
public class BusinessTypeDao extends AbstractDao
{
    ...
    public static void createTable(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ...
        sqlitedatabase.execSQL((new StringBuilder("CREATE TABLE ")).append(s).append("'BUSINESS_TYPE' ('_id' INTEGER PRIMARY KEY AUTOINCREMENT ,'UID' TEXT,'KEY' TEXT,'NAME' TEXT,'HELP' TEXT);").toString());
    }
    ...
    public BusinessType readEntity(Cursor cursor, int i)
    {
        ...
        return new BusinessType(long1, s, s1, s2, cursor);
    }
