...
public class FilterOptionDao extends AbstractDao
{
    ...
    public static void createTable(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ...
        sqlitedatabase.execSQL((new StringBuilder("CREATE TABLE ")).append(s).append("'FILTER_OPTION' ('_id' INTEGER PRIMARY KEY AUTOINCREMENT ,'COUNT' INTEGER,'TYPE_VALUE' TEXT,'DISPLAY_COUNT' TEXT,'DISPLAY_NAME' TEXT,'LARGE_ICON_URL' TEXT,'SMALL_ICON_URL' TEXT,'DOMINANT_COLOR' TEXT);").toString());
    }
    ...
    protected void bindValues(SQLiteStatement sqlitestatement, FilterOption filteroption)
    {
        ...
        {
            sqlitestatement.bindString(8, filteroption);
        }
    }
    ...
    public FilterOption readEntity(Cursor cursor, int i)
    {
        ...
        return new FilterOption(long1, integer, s, s1, s2, s3, s4, cursor);
    }
