...
public class ActorDao extends AbstractDao
{
    ...
    public static void createTable(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ...
        sqlitedatabase.execSQL((new StringBuilder("CREATE TABLE ")).append(s).append("'ACTOR' ('_id' INTEGER PRIMARY KEY ,'UID' TEXT,'TYPE' INTEGER);").toString());
    }
    ...
    protected void bindValues(SQLiteStatement sqlitestatement, Actor actor)
    {
        ...
        if (actor != null)
        {
            sqlitestatement.bindLong(3, actor.intValue());
        }
    }
    ...
    public Actor readEntity(Cursor cursor, int i)
    {
        ...
        return new Actor(long1, s, cursor);
    }
