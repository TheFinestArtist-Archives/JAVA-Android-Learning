...
public class StoryDao extends AbstractDao
{
    ...
    protected void bindValues(SQLiteStatement sqlitestatement, Story story)
    {
        ...
        story = story.getImageUrl();
        if (story != null)
        {
            sqlitestatement.bindString(18, story);
        }
    }
    ...
    public Story readEntity(Cursor cursor, int i)
    {
        ...
        {
            integer3 = Integer.valueOf(cursor.getInt(i + 15));
        }
        ...
        {
            integer4 = Integer.valueOf(cursor.getInt(i + 16));
        }
        ...
        {
            cursor = cursor.getString(i + 17);
        }
        return new Story(long1, s, s1, s2, s3, boolean1, long2, s4, s5, s6, integer, s7, s8, integer1, integer2, integer3, integer4, cursor);
    }
