...
public class UserFeed extends Feed
{
    ...
    public String toCollaboratorsDisplay(Board board, int i)
    {
        ...
        {
            stringbuilder.append(Resources.string(0x7f0e0514));
            j = 1;
        } else
        {
            j = 0;
...
_L5:
        ...
        {
            s = (new StringBuilder(" ")).append(Resources.string(0x7f0e003b)).toString();
        }
...
_L7:
        ...
        if (j > i)
        {
            stringbuilder.append(" ").append(Resources.stringPlural(0x7f0d0001, Integer.valueOf((j - i) + 1)));
        } else
        {
            stringbuilder.append(" ").append(Resources.string(0x7f0e003d));
        }
