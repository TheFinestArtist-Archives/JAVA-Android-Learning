...
public class SearchFilterDao extends AbstractDao
{
    ...
    public static void createTable(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ...
        sqlitedatabase.execSQL((new StringBuilder("CREATE TABLE ")).append(s).append("'SEARCH_FILTER' ('_id' INTEGER PRIMARY KEY AUTOINCREMENT ,'TYPE' TEXT,'DISPLAY_NAME' TEXT,'TYPE_VALUE' TEXT,'MAIN_OPTIONS_TITLE' TEXT,'TOP_OPTIONS_TITLE' TEXT,'DISPLAY_IMAGE_URL' TEXT);").toString());
    }
    ...
    protected void bindValues(SQLiteStatement sqlitestatement, SearchFilter searchfilter)
    {
        ...
        {
            sqlitestatement.bindString(7, searchfilter);
        }
    }
    ...
    public SearchFilter readEntity(Cursor cursor, int i)
    {
        ...
        return new SearchFilter(long1, s, s1, s2, s3, s4, cursor);
    }
