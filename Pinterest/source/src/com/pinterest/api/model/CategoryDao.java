...
public class CategoryDao extends AbstractDao
{
    ...
    public Category readEntity(Cursor cursor, int i)
    {
        ...
        {
            cursor = cursor.getString(i + 12);
        }
        return new Category(long1, s, s1, boolean1, s2, s3, s4, s5, s6, s7, s8, s9, cursor);
    }
