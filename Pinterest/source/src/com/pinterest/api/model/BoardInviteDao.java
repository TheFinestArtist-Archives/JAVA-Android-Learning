...
public class BoardInviteDao extends AbstractDao
{
    ...
    public static void createTable(SQLiteDatabase sqlitedatabase, boolean flag)
    {
        ...
        sqlitedatabase.execSQL((new StringBuilder("CREATE TABLE ")).append(s).append("'BOARD_INVITE' ('_id' INTEGER PRIMARY KEY AUTOINCREMENT ,'UID' TEXT,'CREATED_AT' INTEGER,'INVITER_UID' TEXT NOT NULL ,'BOARD_UID' TEXT NOT NULL ,'STATUS' TEXT,'TYPE' TEXT,'IS_ACCEPTABLE' INTEGER);").toString());
    }
    ...
    protected void bindValues(SQLiteStatement sqlitestatement, BoardInvite boardinvite)
    {
        ...
        sqlitestatement.bindString(4, boardinvite.getInviterUid());
        sqlitestatement.bindString(5, boardinvite.getBoardUid());
    ...
    public BoardInvite readEntity(Cursor cursor, int i)
    {
        ...
        return new BoardInvite(long1, s, date, s3, s4, s1, s2, cursor);
    }
    ...
    public void readEntity(Cursor cursor, BoardInvite boardinvite, int i)
    {
        ...
        boardinvite.setInviterUid(cursor.getString(i + 3));
        boardinvite.setBoardUid(cursor.getString(i + 4));
        if (cursor.isNull(i + 5))
        {
            obj = null;
        } else
