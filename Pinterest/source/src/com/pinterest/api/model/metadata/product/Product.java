...
public class Product extends PinMetadata
{
    ...
    public Product(Pin pin, PinterestJsonObject pinterestjsonobject)
    {
        ...
        pinterestjsonarray = pinterestjsonarray.c(0).d("products");
        pin = obj;
        if (pinterestjsonarray == null)
        {
            break MISSING_BLOCK_LABEL_101;
        }
        pin = (new OfferSummary(pinterestjsonarray.c(0).c("offer_summary"))).getPrice();
        pinterestjsonobject = pinterestjsonobject.e("products").c(0);
