...
public class OfferSummary
{
    ...
    public OfferSummary(PinterestJsonObject pinterestjsonobject, String s)
    {
        ...
        } else
        {
            ...
            _oldPrice = s;
            _offerDisplay = makeOfferDisplay();
            return;
        }
    }
    ...
    private String makeOfferDisplay()
    {
        ...
        {
            stringbuilder.append(Resources.string(0x7f0e03b3));
        } else
        if (Boolean.FALSE.equals(_inStock))
        {
            stringbuilder.append(Resources.string(0x7f0e03b4));
        }
        if (ModelHelper.isValid(_price) && ModelHelper.isValid(_oldPrice) && isNewPriceLower(_oldPrice, _price))
        {
            ...
            stringbuilder.append(Resources.string(0x7f0e03b5, new Object[] {
                _price, _oldPrice
            }));
        } else
