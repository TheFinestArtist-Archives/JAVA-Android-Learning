...
//            PinterestJsonObject, PinterestJsonArray
...
public class ApiResponse
{
    ...
    public static final List ACCOUNT_FAILURE = Arrays.asList(new Integer[] {
...
_L5:
        ...
        {
            CrashReporting.logHandledException(pinterestjsonobject);
        }
        return;
    }
    ...
    {
        return (new StringBuilder("ApiResponse{_status='")).append(_status).append('\'').append(", _code=").append(_code).append(", _data=").append(_data).append('}').toString();
    }
