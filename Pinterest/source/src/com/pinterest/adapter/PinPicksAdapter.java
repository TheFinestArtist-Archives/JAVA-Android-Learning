...
public class PinPicksAdapter extends PinterestBaseAdapter
{
    ...
    {
        return ((PinPicksSections)getItem(i)).isGridSection() && (getItemViewType(i) == 4 || getItemViewType(i) == 3);
    }
...
label0:
    ...
    private void updateFollowBtn(PersonListCell personlistcell, User user)
    {
        ...
        {
            personlistcell.setActionButton(Resources.string(0x7f0e022e), onFollowClicked);
            personlistcell.setActionButtonStyle(com.pinterest.ui.text.PButton.ButtonStyle.RED);
        } else
        {
            personlistcell.setActionButton(Resources.string(0x7f0e04c8), onFollowClicked);
    ...
    public int getItemHeight(int i, int j)
    {
        ...
        if (isBoardGridCell(i))
        {
            ...
            {
                k = ((Integer)_cachedItemHeights.get(Integer.valueOf(i - 1))).intValue();
            }
        } else
        {
            k = ((flag) ? 1 : 0);
...
_L1:
    ...
    //                   7 316
    //                   8 171;
           goto _L2 _L3 _L3 _L3 _L3 _L4 _L5 _L6 _L7 _L8
_L2:
        return view;
_L3:
...
_L6:
        ...
        {
            viewgroup = (PersonListCell)getInflater(view, viewgroup).inflate(0x7f0300ed, null);
            view = viewgroup;
            if (viewgroup != null)
            {
...
_L7:
        ...
        {
            view = (PinPicksTitleSectionText)getInflater(view, viewgroup).inflate(0x7f030105, null);
        } else
        {
        ...
        implements android.view.View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            {
                view = (FollowRunnable)PinPicksAdapter._runnableMap.get(user);
