...
public class CategoryListAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null || view.getTag() == null)
        {
            ...
            view = _inflater.inflate(0x7f0300e1, viewgroup, false);
            viewgroup = new CategoryHolder(null);
            viewgroup.iconIv = (WebImageView)view.findViewById(0x7f0b01d8);
            viewgroup.titleTv = (TextView)view.findViewById(0x7f0b0065);
            viewgroup.checkIv = view.findViewById(0x7f0b020b);
        ...
        if (((String) (obj)).equals(_board.getCategory()))
        {
            ...
            view.setBackgroundResource(0x7f0201c3);
            return view;
        } else
        {
            ((CategoryHolder) (viewgroup)).titleTv.setTypeface(null, 0);
            view.setBackgroundResource(0x7f0201c1);
            return view;
        }
    }
