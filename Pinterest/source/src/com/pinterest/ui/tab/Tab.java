    ...
    implements Checkable
{
    ...
    private void init(Context context, AttributeSet attributeset)
    {
        ...
        if (attributeset != null)
        {
            ...
            _textSize = context.getDimension(4, getResources().getDimension(0x7f0a00f5));
            ...
            _iconPop = context.getBoolean(7, false);
            context.recycle();
        } else
        {
        ...
        if (_orientation == 1)
        {
            setGravity(1);
            context.height = -2;
            context.topMargin = getResources().getDimensionPixelOffset(0x7f0a009b);
            context.bottomMargin = getResources().getDimensionPixelOffset(0x7f0a009b);
        }
