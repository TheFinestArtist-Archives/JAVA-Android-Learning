...
public class MetadataBar extends LinearLayout
{
    ...
    {
        _iconResId = 0x7f020134;
        if (board.getPinCount().intValue() > 0)
        {
            _titleText = Resources.stringPlural(0x7f0d0015, board.getPinCount());
        }
    }

    private void extractInterestDetails(Interest interest, Mode mode)
    {
        _iconResId = 0x7f020116;
        if (interest.getPinnerCount().intValue() > 0)
        {
            _titleText = Resources.stringPlural(0x7f0d0007, interest.getPinnerCount());
        }
    }
...
_L2:
        j = 0x7f020125;
        i = 0x7f0d000d;
        pin = pin.getLikeCount();
        continue; /* Loop/switch isn't completed */
_L3:
        j = 0x7f020116;
        i = 0x7f0d0004;
        pin = pin.getCommentCount();
...
_L6:
    ...
    {
        setOrientation(1);
        LayoutInflater.from(getContext()).inflate(0x7f03001c, this, true);
        ButterKnife.a(this);
    }
