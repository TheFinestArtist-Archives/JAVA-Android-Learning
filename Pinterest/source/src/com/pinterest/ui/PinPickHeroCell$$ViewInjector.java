...
public class 
{
    ...
    {
        pinpickherocell._heroImageView = (WebImageView)ctor.eView(obj, 0x7f0b0252, "field '_heroImageView'");
        pinpickherocell._titleTv = (TextView)ctor.eView(obj, 0x7f0b0253, "field '_titleTv'");
        pinpickherocell._subTitleTv = (TextView)ctor.Tv(obj, 0x7f0b0254, "field '_subTitleTv'");
    }
