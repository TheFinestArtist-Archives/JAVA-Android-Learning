...
public abstract class PinCellDrawable extends Drawable
{
    ...
    public static final int DIVIDER_HEIGHT = (int)Resources.dimension(0x7f0a008c);
    ...
    protected static final int ICON_IMAGE_SIZE = (int)Resources.dimension(0x7f0a00b6);
    protected static final int ICON_SIZE = (int)Resources.dimension(0x7f0a00f8);
    protected static final int PADDING_IMAGE = (int)Resources.dimension(0x7f0a00b2);
    ...
    {
        nameSize = Resources.dimension(0x7f0a00f8);
        subTitleSize = Resources.dimension(0x7f0a00f9);
    }
