...
public class AdapterEmptyView extends FrameLayout
{
    ...
    private void hideViews(boolean flag)
    {
        ...
        } else
        {
            ...
            if (!Device.isTablet())
            {
                _container.setPadding(_container.getPaddingLeft(), (int)(Resources.dimension(0x7f0a0084) / 2.0F), _container.getPaddingRight(), _container.getPaddingBottom());
                return;
            }
        }
    }
    ...
    private void init()
    {
        View view = ViewHelper.viewById(getContext(), 0x7f0300f9);
        _spinner = (LoadingView)view.findViewById(0x7f0b0233);
        _centerIv = (ObservableImageView)view.findViewById(0x7f0b023b);
        _messageTv = (TextView)view.findViewById(0x7f0b00d0);
        _actionBt = (Button)view.findViewById(0x7f0b023a);
        _refreshBt = (Button)view.findViewById(0x7f0b0236);
        _wrapper = (ViewGroup)view.findViewById(0x7f0b0234);
        _container = view.findViewById(0x7f0b0159);
        _noInternet = view.findViewById(0x7f0b0235);
        _leftIv = (ObservableImageView)view.findViewById(0x7f0b0239);
        _rightIv = (ObservableImageView)view.findViewById(0x7f0b0238);
        _textContainer = (LinearLayout)view.findViewById(0x7f0b0185);
        _imageContainer = (RelativeLayout)view.findViewById(0x7f0b0237);
        _isAnimating = false;
    ...
    private void showViews()
    {
        ...
        if (!Device.isTablet())
        {
            _container.setPadding(_container.getPaddingLeft(), (int)Resources.dimension(0x7f0a0084), _container.getPaddingRight(), _container.getPaddingBottom());
        }
    }
...
_L3:
    ...
    {
        _container.setBackgroundResource(0x7f0201c9);
        if (CUSTOM_PADDING)
        {
            View view = findViewById(0x7f0b0232);
            if (view != null)
    ...
    {
        setCustomView(0x7f0300fc, false);
        resetDefaults();
    }
