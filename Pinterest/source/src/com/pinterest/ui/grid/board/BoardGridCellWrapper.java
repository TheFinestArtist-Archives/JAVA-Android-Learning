...
public class BoardGridCellWrapper extends LinearLayout
{
    ...
    protected void init()
    {
        ...
        setOrientation(1);
        flipper = (ViewFlipper)findViewById(0x7f0b01e9);
        cell1 = (BoardGridCell)findViewById(0x7f0b01ea);
        cell1.setOnClickListener(onBoardClicked);
        cell2 = (BoardGridCell)findViewById(0x7f0b01eb);
        cell2.setOnClickListener(onBoardClicked);
        dismissBt = findViewById(0x7f0b01ec);
        flipper.setInAnimation(getContext(), 0x7f040018);
        flipper.setOutAnimation(getContext(), 0x7f04001c);
