...
public class 
{
    ...
    {
        pinterestgridview._content = (LinearLayout)winjector.tent(obj, 0x7f0b016a, "field '_content'");
        pinterestgridview._emptyVw = (AdapterEmptyView)winjector.tyVw(obj, 0x7f0b0140, "field '_emptyVw'");
        pinterestgridview._adapterVw = (PinterestAdapterView)winjector.pterVw(obj, 0x7f0b02d0, "field '_adapterVw'");
        pinterestgridview._footerVw = (AdapterFooterView)winjector.terVw(obj, 0x7f0b02a5, "field '_footerVw'");
    }
