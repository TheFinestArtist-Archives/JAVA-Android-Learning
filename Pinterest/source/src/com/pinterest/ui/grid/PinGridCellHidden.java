...
public class PinGridCellHidden extends View
{
    ...
    protected static final String STR_SUBTITLE = Resources.string(0x7f0e0506);
    protected static final String STR_THANKS = Resources.string(0x7f0e04a9);
    protected static final String STR_TITLE = Resources.string(0x7f0e04ae);
    ...
    {
        Events.post(new DialogEvent(new AdditionalPinFeedbackDialog(_pin)));
    }
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (_pin != null)
        {
            ...
            _titleDrawable.setTextSize(Resources.dimension(0x7f0a00f6));
            ...
            if (ModelHelper.isValid(_pin.getHiddenState()) && _pin.getHiddenState().intValue() == 1)
            {
                ...
                _subtitleDrawable.setTextSize(Resources.dimension(0x7f0a00f6));
