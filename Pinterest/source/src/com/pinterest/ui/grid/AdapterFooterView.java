...
public class AdapterFooterView extends RelativeLayout
{
    ...
    private void init()
    {
        inflate(getContext(), 0x7f0300fd, this);
        setBackgroundResource(0x7f0200dc);
        _spinner = (LoadingView)findViewById(0x7f0b0233);
        _footerLayout = findViewById(0x7f0b023c);
        updateView();
    }
    ...
    {
        findViewById(0x7f0b023d).setVisibility(i);
    }
