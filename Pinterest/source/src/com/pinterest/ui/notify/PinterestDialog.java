...
public class PinterestDialog extends Dialog
{
    ...
    public PinterestDialog(Context context)
    {
        ...
        contentPadding = (int)getContext().getResources().getDimension(0x7f0a0098);
        init(context);
    }
    ...
    private void init(Context context)
    {
        ...
        content = LayoutInflater.from(context).inflate(0x7f030053, null);
    ...
    public void setMessage(Spanned spanned)
    {
        ...
        TextView textview = new TextView(getContext(), null, 0x7f0f013c);
