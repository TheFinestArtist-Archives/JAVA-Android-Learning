...
public class DialogAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            ...
            View view1 = LayoutInflater.from(viewgroup.getContext()).inflate(0x7f0300e1, null, false);
            view.titleTv = (TextView)view1.findViewById(0x7f0b0065);
            view.iconIv = (ImageView)view1.findViewById(0x7f0b01d8);
            view.divider = view1.findViewById(0x7f0b01de);
            view1.setTag(view);
            viewgroup = view;
            view = view1;
        } else
