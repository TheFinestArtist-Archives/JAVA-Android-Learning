...
public class DialogCheckedTextViewAdapter extends BaseAdapter
{
    ...
    public View getView(int i, View view, ViewGroup viewgroup)
    {
        ...
        if (view == null)
        {
            view1 = ViewHelper.viewById(viewgroup.getContext(), 0x7f0300d4);
        }
        view = (CheckedTextView)view1.findViewById(0x7f0b01f1);
        if (view != null)
        {
            view.setText(getItem(i));
            try
            {
                view.setChecked("anyone".equals(_notifs.c(i).a("value", null)));
            }
