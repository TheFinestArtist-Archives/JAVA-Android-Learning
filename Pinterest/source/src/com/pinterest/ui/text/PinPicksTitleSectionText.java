...
public class PinPicksTitleSectionText extends LinearLayout
{
    ...
    {
        _titleEt.setTextColor(Resources.color(0x7f09006b));
        _subtitleEt.setTextColor(Resources.color(0x7f09006b));
    }
    ...
    {
        _titleEt.setTextColor(Resources.color(0x7f090073));
        _subtitleEt.setTextColor(Resources.color(0x7f090073));
    }
}
