...
public class PButton extends Button
{
    ...
    public void setStyle(ButtonStyle buttonstyle)
    {
        ...
        setEnabled(true);
        switch (_cls1..SwitchMap.com.pinterest.ui.text.PButton.ButtonStyle[buttonstyle.ordinal()])
        {
        default:
            return;

        case 1: // '\001'
            setBackgroundResource(0x7f02005d);
            setTextColor(-1);
            return;

        case 2: // '\002'
            setBackgroundResource(0x7f020042);
            setTextColor(getResources().getColor(0x7f09006b));
            return;
        ...
        setTextColor(getResources().getColor(0x7f09006c));
        setEnabled(false);
    }
