...
public class ContextMenuItemView extends SpringLinearLayout
{
    ...
    private static final float TOOLTIP_BOTTOM_PADDING = Resources.dimension(0x7f0a005d);
    ...
    public ContextMenuItemView(Context context, AttributeSet attributeset)
    {
        ...
        _bgOn = DrawableUtils.tintIcon(0x7f0200be, 0x7f090061);
        _bgOff = DrawableUtils.tintIcon(0x7f0200be, 0x7f09000a);
    }
    ...
    protected void onFinishInflate()
    {
        ...
        _imageView = (IconView)findViewById(0x7f0b0039);
        _imageView.setTint(0x7f090073);
        _tooltipView = (TextView)findViewById(0x7f0b0093);
        _tooltipView.setVisibility(4);
        updateView();
    }
