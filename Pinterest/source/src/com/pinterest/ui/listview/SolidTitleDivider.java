...
public class SolidTitleDivider extends LinearLayout
{
    ...
    private void init(AttributeSet attributeset)
    {
        ...
        setOrientation(1);
        setGravity(1);
        LayoutInflater.from(getContext()).inflate(0x7f030140, this, true);
        _titleTv = (TextView)findViewById(0x7f0b02d6);
        _dividerBottom = findViewById(0x7f0b02d7);
        _dividerTop = findViewById(0x7f0b02d5);
