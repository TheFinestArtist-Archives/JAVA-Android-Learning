...
public class ListCellBasic extends FrameLayout
{
    ...
    private static final int DIMEN_NORMAL = (int)Resources.dimension(0x7f0a0103);
    private static final int DIMEN_SMALL = (int)Resources.dimension(0x7f0a0105);
    ...
    private void init()
    {
        ...
        _imageVw = (GrayWebImageView)findViewById(0x7f0b01d8);
        _textVw = (TextView)findViewById(0x7f0b0065);
        _superTextVw = (TextView)findViewById(0x7f0b01dd);
        _dividerVw = findViewById(0x7f0b01de);
    }
