...
public class 
{
    ...
    {
        listcelldialog._titleTv = (TextView)viewinjector._titleTv(obj, 0x7f0b0065, "field '_titleTv'");
        listcelldialog._iconView = (IconView)viewinjector._iconView(obj, 0x7f0b01df, "field '_iconView'");
        listcelldialog._dividerVw = viewinjector._dividerVw(obj, 0x7f0b01de, "field '_dividerVw'");
    }
