...
//            ViewParameterType, AppType

public class event_ifConstants
{

    public static final List CategoryFeedTypes;
    public static final Set MOBILE_APPS;

    public event_ifConstants()
    {
    }
    ...
    static 
    {
        ...
        CategoryFeedTypes = ((List) (obj));
        ((List) (obj)).add(ViewParameterType.FEED_CATEGORY_ANIMALS);
        ...
        CategoryFeedTypes.add(ViewParameterType.FEED_CATEGORY_HOLIDAY_FOR_HIM);
        CategoryFeedTypes.add(ViewParameterType.FEED_CATEGORY_HOLIDAY_FOR_HER);
        CategoryFeedTypes.add(ViewParameterType.FEED_CATEGORY_HOLIDAY_FOR_KIDS);
        CategoryFeedTypes.add(ViewParameterType.FEED_CATEGORY_HOLIDAY_FOR_ALL);
        CategoryFeedTypes.add(ViewParameterType.FEED_CATEGORY_CHRISTMAS_SWEATER);
        obj = new HashSet();
        MOBILE_APPS = ((Set) (obj));
        ((Set) (obj)).add(AppType.IPHONE);
        MOBILE_APPS.add(AppType.IPAD);
        MOBILE_APPS.add(AppType.ANDROID_MOBILE);
        MOBILE_APPS.add(AppType.ANDROID_TABLET);
    }
}
