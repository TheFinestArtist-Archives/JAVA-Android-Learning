...
public class GcmRegistrar
{
    ...
    {
        AccountApi.b(b(), new UnRegisterPushTokenResponseHandler((byte)0));
        class GcmEvent.Type extends Enum
        {
            ...
            public static GcmEvent.Type valueOf(String s)
            {
                return (GcmEvent.Type)Enum.valueOf(com/pinterest/gcm/GcmRegistrar$GcmEvent$Type, s);
            }
    ...
    public static void a(String s)
    {
        ...
        if (flag || flag1)
        {
            PLog.a((new StringBuilder("GcmRegistrar: Saving regId on app version ")).append(i).toString(), new Object[0]);
    ...
    public static String b()
    {
        ...
        if (s.isEmpty())
        {
            PLog.a("GcmRegistrar: Registration not found.", new Object[0]);
            s = "";
        } else
        if (Preferences.user().getInt("PREF_GCM_APP_VERSION", 0x80000000) != ApplicationInfo.getVersionCode())
        {
            PLog.a("GcmRegistrar: App version changed.", new Object[0]);
            return "";
        }
        return s;
    }
