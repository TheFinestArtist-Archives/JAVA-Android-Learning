...
public class PWidgetSearch extends AppWidgetProvider
{
    ...
    private void initWidgetSearch(AppWidgetManager appwidgetmanager, int ai[])
    {
        ...
        {
            RemoteViews remoteviews = new RemoteViews(mContext.getPackageName(), 0x7f03015a);
            remoteviews.setOnClickPendingIntent(0x7f0b0159, PWidgetHelper.getSearchPending(mContext));
