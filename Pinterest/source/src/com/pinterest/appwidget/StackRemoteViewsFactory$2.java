...
class nit> extends FeedApiResponseHandler
{
    ...
    {
        PLog.a((new StringBuilder("FeedApiResponseHandler.onFailure, retry: ")).append(StackRemoteViewsFactory.access$300()).toString(), new Object[0]);
    ...
    public void onSuccess(PinterestJsonObject pinterestjsonobject)
    {
        ...
        PLog.a((new StringBuilder("onGridLoad.onSuccess feed count: ")).append(StackRemoteViewsFactory.access$000(StackRemoteViewsFactory.this).getCount()).toString(), new Object[0]);
