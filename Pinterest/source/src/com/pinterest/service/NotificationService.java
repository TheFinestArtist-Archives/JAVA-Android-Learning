...
public class NotificationService extends Service
{
    ...
    {
        _running = true;
        PLog.a("NotificationService started", new Object[0]);
    ...
    private class _cls2 extends ApiResponseHandler
    {
        ...
        {
            PLog.a("onNotifLoad.onFailure", new Object[0]);
            stopSelf();
        }
        ...
        public void onSuccess(ApiResponse apiresponse)
        {
            ...
            try
            {
                apiresponse = ((PinterestJsonArray)apiresponse.getData()).b(0);
            }
            ...
            PLog.a((new StringBuilder("onNotifLoad.onSuccess: ")).append(flag).toString(), new Object[0]);
            if (!flag)
            {
                stopSelf();
                return;
