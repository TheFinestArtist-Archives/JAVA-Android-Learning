...
public class ImageLoader
{
    ...
    protected Request makeImageRequest(String s, int i, int j, final String cacheKey)
    {
        return new ImageRequest(s, new _cls2(), i, j, android.graphics.Bitmap.Config.RGB_565, new _cls3());
    }
...
*/
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                BatchedImageRequest batchedimagerequest = (BatchedImageRequest)iterator.next();
        ...
        implements ImageListener
    {
        ...
        public final void onResponse(ImageContainer imagecontainer, boolean flag)
        {
