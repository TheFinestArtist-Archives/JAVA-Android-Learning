...
public class MisoApi extends DefaultApi10a
{
    ...
    {
        return "http://gomiso.com/oauth/access_token";
    }

    public String getAuthorizationUrl(Token token)
    {
        return String.format("http://gomiso.com/oauth/authorize?oauth_token=%s", new Object[] {
            token.getToken()
        });
    }
    ...
    {
        return "http://gomiso.com/oauth/request_token";
    }
}
