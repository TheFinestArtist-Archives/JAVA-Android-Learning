...
label0:
    ...
    private int readNextToken(char ac[], int i, int j, StrBuilder strbuilder, List list)
    {
        do
        {
            ...
            int k = Math.max(getIgnoredMatcher().isMatch(ac, i, i, j), getTrimmerMatcher().isMatch(ac, i, i, j));
    ...
    public String toString()
    {
        ...
        {
            return (new StringBuilder("StrTokenizer")).append(getTokenList()).toString();
        }
    }
...
_L5:
    ...
    static 
    {
        ...
        TSV_TOKENIZER_PROTOTYPE = strtokenizer;
        strtokenizer.setDelimiterMatcher(StrMatcher.tabMatcher());
