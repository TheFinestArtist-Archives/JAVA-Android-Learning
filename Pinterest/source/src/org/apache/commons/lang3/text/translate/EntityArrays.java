...
public class EntityArrays
{
    ...
    static 
    {
        ...
        HTML40_EXTENDED_ESCAPE = as;
        HTML40_EXTENDED_UNESCAPE = invert(as);
        as = new String[4][];
        as[0] = (new String[] {
            "\"", "&quot;"
        });
        ...
        BASIC_ESCAPE = as;
        BASIC_UNESCAPE = invert(as);
        as = new String[1][];
        as[0] = (new String[] {
            "'", "&apos;"
        });
        APOS_ESCAPE = as;
        APOS_UNESCAPE = invert(as);
        as = new String[5][];
        as[0] = (new String[] {
            "\b", "\\b"
        });
        ...
        JAVA_CTRL_CHARS_ESCAPE = as;
        JAVA_CTRL_CHARS_UNESCAPE = invert(as);
    }
}
