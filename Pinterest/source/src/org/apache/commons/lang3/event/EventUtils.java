...
public class EventUtils
{
    ...
    public static void addEventListener(Object obj, Class class1, Object obj1)
    {
        try
        {
            MethodUtils.invokeMethod(obj, (new StringBuilder("add")).append(class1.getSimpleName()).toString(), new Object[] {
                obj1
            });
            return;
        }
        ...
        {
            throw new IllegalArgumentException((new StringBuilder("Class ")).append(obj.getClass().getName()).append(" does not have a public add").append(class1.getSimpleName()).append(" method which takes a parameter of type ").append(class1.getName()).append(".").toString());
        }
        // Misplaced declaration of an exception variable
        catch (Object obj1)
        {
            throw new IllegalArgumentException((new StringBuilder("Class ")).append(obj.getClass().getName()).append(" does not have an accessible add").append(class1.getSimpleName()).append(" method which takes a parameter of type ").append(class1.getName()).append(".").toString());
        }
        // Misplaced declaration of an exception variable
        catch (Object obj)
        {
    ...
    private class EventBindingInvocationHandler
