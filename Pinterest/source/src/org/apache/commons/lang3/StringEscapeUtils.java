...
public class StringEscapeUtils
{
    ...
    static 
    {
        ...
        obj = new AggregateTranslator(new CharSequenceTranslator[] {
            obj, unicodeunescaper, lookuptranslator, new LookupTranslator(new String[][] {
                as1, new String[] {
                    "\\\"", "\""
                }, as2, as3
            })
    ...
    private class CsvEscaper extends CharSequenceTranslator
    {
    ...
    private class CsvUnescaper extends CharSequenceTranslator
    {
