...
_L3:
    ...
    public static int getLevenshteinDistance(CharSequence charsequence, CharSequence charsequence1, int i)
    {
        ...
        charsequence1 = new int[k + 1];
        charsequence = new int[k + 1];
        i1 = Math.min(k, i) + 1;
        for (l = 0; l < i1; l++)
        {
            charsequence1[l] = l;
        ...
        do
        {
            ...
            charsequence[0] = l;
            int k1 = Math.max(1, l - i);
            int l1 = Math.min(k, l + i);
            if (k1 > l1)
            {
                return -1;
            }
        ...
        if (charsequence4[k] <= i)
        {
            return charsequence4[k];
        } else
        {
            return -1;
        }
...
_L7:
    ...
    public static String stripAccents(String s)
    {
        ...
        try
        {
            ...
            {
                throw new UnsupportedOperationException((new StringBuilder("The stripAccents(CharSequence) method requires at least Java6, but got: ")).append(InitStripAccents.java6Exception).append("; or a Sun JVM: ").append(InitStripAccents.sunException).toString());
            }
        }
...
label0:
    ...
    private class InitStripAccents
    {
