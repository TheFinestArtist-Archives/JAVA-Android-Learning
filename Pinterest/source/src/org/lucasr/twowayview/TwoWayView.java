...
_L18:
        ...
        view = null;
        mLayoutMode;
        JVM INSTR tableswitch 1 5: default 1177
    //                   1 1180
    //                   2 288
    //                   3 1180
    //                   4 1180
...
_L84:
        ...
        mLayoutMode;
        JVM INSTR tableswitch 1 6: default 1195
    //                   1 870
    //                   2 782
    //                   3 850
    //                   4 889
...
_L5:
    ...
    private boolean scrollListItemsBy(int i)
    {
        ...
        if (k3 + j3 == mItemCount && k1 <= i2 && j2 <= 0)
        {
            j = 1;
        } else
        {
        ...
        if (flag1)
        {
            ...
            do
            {
                ...
                mRecycler.addScrapView(view1, k3 + k);
                k++;
                i++;
            } while (true);
        } else
        {
            ...
            do
            {
                ...
                mRecycler.addScrapView(view2, k3 + i);
                l++;
                i1 = i;
                i--;
            } while (true);
        ...
        if (flag1)
        {
            mFirstPosition = k2 + mFirstPosition;
        }
        i = Math.abs(j2);
        if (l1 - j1 < i || k1 - i2 < i)
        {
...
_L2:
    ...
    void fillGap(boolean flag)
    {
        ...
        if (flag)
        {
            ...
            if (mIsVertical)
            {
                j = getChildAt(i1 - 1).getBottom();
            } else
            {
                j = getChildAt(i1 - 1).getRight();
            }
            if (i1 > 0)
            {
                i = mItemMargin + j;
            }
            fillAfter(mFirstPosition + i1, i);
            correctTooHigh(getChildCount());
            return;
        }
        if (mIsVertical)
